...
"Tenderloin": {
    aka: "The TL",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Tenderloin&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Tenderloin)",
    route: {
      // Route stays ENTIRELY within the Tenderloin boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Golden Gate & Market — Golden Gate Theatre", note: "Start — a grand old 1922 theater on the Market St edge", coord: [-122.4108, 37.7820] },
        { n: 2, name: "Larkin & O'Farrell — Little Saigon", note: "The Little Saigon corridor: Vietnamese kitchens and shops", coord: [-122.4178, 37.7842] },
        { n: 3, name: "Eddy & Jones — historic SRO block", note: "Intact early-1900s apartment & SRO streetscape (National Register district)", coord: [-122.4128, 37.7833] },
        { n: 4, name: "Boeddeker Park", note: "The neighborhood's pocket park at Eddy & Jones", coord: [-122.4118, 37.7836] },
        { n: 5, name: "Geary & Taylor — theater row edge", note: "Grand old theaters near the Union Square edge", coord: [-122.4106, 37.7864] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON A TENDERLOIN CORNER OFF MARKET, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE THE TENDERLOIN? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Tenderloin corner in the next", "You moving up the block into frame off Market", "A grand old theater marquee to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? THE TENDERLOIN SITS RIGHT DOWNTOWN IN SAN FRANCISCO,\n" +
          "JUST OFF MARKET STREET, WITH UNION SQUARE TO THE NORTHEAST,\n" +
          "CIVIC CENTER TO THE WEST AND NOB HILL CLIMBING ABOVE TO THE NORTH.\n" +
          "THIS IS A TIGHT, DENSE GRID OF BLOCKS — LARKIN, HYDE, JONES, TAYLOR,\n" +
          "EDDY, TURK AND O'FARRELL — PACKED WITH APARTMENT BUILDINGS.\n" +
          "AND HERE'S THE GOOD NEWS FOR GETTING AROUND: IT'S FLAT.\n" +
          "THE LAND RUNS ONLY FROM ABOUT 40 FEET UP TO AROUND 150,\n" +
          "A LEVEL DOWNTOWN GRID THAT'S GENUINELY EASY TO GET AROUND —\n" +
          "WELL WITHIN WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE, ABOUT FIVE PERCENT —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "SO THE STREETS THEMSELVES ARE ABOUT AS EASY AS SAN FRANCISCO GETS.\n" +
          "THE HOMES ARE THE PART TO CHECK. THESE ARE DENSE APARTMENT BUILDINGS,\n" +
          "MANY OF THEM A CENTURY OLD, AND PLENTY HAVE A FLIGHT OF STAIRS\n" +
          "AT THE ENTRANCE OR AN OLDER, SMALLER ELEVATOR INSIDE.\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING BUILDING BY BUILDING.",
        broll: ["Slow pan up a Tenderloin block; street signs at Eddy & Jones", "Wide establishing shot showing the flat downtown grid + Nob Hill rising behind", "A historic apartment entrance up a short flight of stairs"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY — AND THE TENDERLOIN HAS ONE OF THE RICHEST IN THE CITY.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "THIS IS ONE OF SAN FRANCISCO'S DENSEST, MOST HISTORIC DISTRICTS —\n" +
          "AN ALMOST INTACT EARLY-1900s STREETSCAPE OF APARTMENT HOUSES AND S-R-O HOTELS,\n" +
          "REBUILT ALL AT ONCE AFTER THE 1906 EARTHQUAKE AND FIRE.\n" +
          "THE UPTOWN TENDERLOIN IS NOW A NATIONAL REGISTER HISTORIC DISTRICT,\n" +
          "WITH THE WORLD'S LARGEST COLLECTION OF HISTORIC RESIDENTIAL HOTELS.\n" +
          "IT HAS DEEP IMMIGRANT AND LGBTQ HISTORY: IN 1966, AT COMPTON'S CAFETERIA,\n" +
          "TRANS WOMEN AND DRAG QUEENS ROSE UP AGAINST POLICE HARASSMENT —\n" +
          "ONE OF THE FIRST QUEER UPRISINGS IN AMERICAN HISTORY, YEARS BEFORE STONEWALL.\n" +
          "AFTER 1975, REFUGEES FROM VIETNAM, CAMBODIA AND LAOS PUT DOWN ROOTS HERE\n" +
          "AND BUILT 'LITTLE SAIGON' ALONG LARKIN STREET.\n" +
          "AND THESE BLOCKS HOLD GRAND OLD THEATERS FROM ITS NIGHTLIFE HEYDAY.\n" +
          "I'LL BE STRAIGHT WITH YOU — THE TENDERLOIN HAS REAL CHALLENGES TODAY,\n" +
          "AND I KEEP THE HONEST, DAY-TO-DAY SPECIFICS CURRENT ON MY DETAILS PAGE.\n" +
          "BUT STAND ON THESE BLOCKS, AND YOU'RE STANDING IN LIVING SAN FRANCISCO HISTORY.",
        broll: ["Intact early-1900s SRO and apartment facades", "The Little Saigon corridor on Larkin St", "A grand old theater marquee; the Compton's Cafeteria site marker"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THE WHOLE NICKNAME — 'THE TENDERLOIN' — IS WIDELY TRACED TO VICE-ERA POLICE:\n" +
          "OFFICERS WORKING THIS LUCRATIVE BEAT COULD AFFORD THE FINEST CUT OF MEAT.\n" +
          "THE UPTOWN TENDERLOIN HISTORIC DISTRICT, LISTED IN 2009,\n" +
          "HAS OVER 400 CONTRIBUTING BUILDINGS — THE WORLD'S LARGEST GROUP OF S-R-O HOTELS.\n" +
          "IN 2004 THE CITY OFFICIALLY DESIGNATED THE LARKIN STREET CORRIDOR 'LITTLE SAIGON.'\n" +
          "AND DURING PROHIBITION, A REAL SPEAKEASY OPERATED ON JONES STREET FROM 1921 TO 1933,\n" +
          "HIDDEN BEHIND A SIGN THAT READ 'ANTI-SALOON LEAGUE.'\n" +
          "THE 1966 COMPTON'S CAFETERIA UPRISING HAPPENED HERE THREE YEARS BEFORE STONEWALL.\n" +
          "THIS IS A NEIGHBORHOOD THAT HAS BEEN AT THE CENTER OF THE CITY'S STORY FOR A CENTURY.",
        broll: ["SRO hotel facade tight shot", "Little Saigon signage on Larkin St", "A grand old theater marquee at dusk"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "THE TENDERLOIN SITS LOW AND FLAT IN THE DOWNTOWN CORE,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND THE TENDERLOIN IS, FLAT-OUT,\n" +
          "ONE OF THE EASIEST PLACES IN THE WHOLE CITY TO LIVE WITHOUT A CAR.\n" +
          "TRANSIT HERE IS EXCEPTIONAL. CIVIC CENTER AND POWELL STREET STATIONS\n" +
          "SIT RIGHT ON THE EDGES — BOTH BART AND MUNI METRO, J, K, L, M, N AND T.\n" +
          "DOZENS OF BUS LINES THREAD THROUGH THESE BLOCKS,\n" +
          "AND THE HISTORIC F-LINE STREETCAR RUNS ALONG MARKET TO THE FERRY BUILDING.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT A MILE AND A HALF NORTHEAST,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? FROM CIVIC CENTER, TAKE BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT TWENTY MINUTES DOOR TO PLATFORM.\n" +
          "HEADING NORTH TO MARIN? TAKE MUNI OR THE F-LINE TO THE FERRY BUILDING\n" +
          "AND THE LARKSPUR FERRY CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE MUNI TO THE CALTRAIN DEPOT\n" +
          "AT 4TH AND KING, AND CALTRAIN RUNS DOWN TO PALO ALTO IN ABOUT FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: TWO BART-AND-MUNI STATIONS AT YOUR DOOR,\n" +
          "WATER, RAIL, AND THREE BRIDGES — ALL WITHOUT OWNING A CAR.",
        broll: [
          "Civic Center / Powell station entrances; an F-line streetcar on Market",
          "The Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: Tenderloin → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS FIRST: THE TENDERLOIN SITS INLAND AND FLAT IN THE DOWNTOWN CORE,\n" +
          "WELL BACK FROM THE BAY, SO IT IS NOT IN A TSUNAMI HAZARD ZONE —\n" +
          "CROSS THAT WORRY OFF THE LIST.\n" +
          "ON EARTHQUAKES: PARTS OF THE NEIGHBORHOOD\n" +
          "DO FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THAT'S STANDARD FOR THIS PART OF THE CITY, AND IT'S SOMETHING\n" +
          "EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing down the flat downtown grid", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "THE TENDERLOIN IS ONE OF THE GREAT EATING NEIGHBORHOODS IN THE CITY —\n" +
          "LITTLE SAIGON'S VIETNAMESE KITCHENS, THAI SPOTS, AND SOME OF THE BEST\n" +
          "CHEAP EATS IN SAN FRANCISCO, PLUS A NIGHTLIFE SCENE WITH REAL HISTORY,\n" +
          "INCLUDING PROHIBITION-ERA SPEAKEASY BARS THAT ARE STILL POURING.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY TENDERLOIN DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A RIGHT-OUTSIDE-YOUR-DOOR, LEAVE-THE-CAR-HOME KIND OF PLACE.",
        broll: ["A Vietnamese kitchen window; a busy counter at lunch", "A grand old theater lit up; people on the sidewalk", "A classic speakeasy doorway (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: THE TENDERLOIN IS DENSE, URBAN SAN FRANCISCO —\n" +
          "MOSTLY EARLY-1900s APARTMENT BUILDINGS AND HISTORIC S-R-O HOTELS,\n" +
          "WITH SOME NEWER CONDO BUILDINGS MIXED IN NEARER THE EDGES.\n" +
          "IT RUNS FROM A FIRST CITY CONDO TO A UNIT IN A HANDSOME HISTORIC BUILDING.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR THE TENDERLOIN ON MY SITE —\n" +
          "CURRENT MEDIANS FOR CONDOS AND FOR THE BUILDINGS HERE, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A historic apartment building, an SRO facade, a newer condo entry", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN THE TENDERLOIN?\n" +
          "SOMEONE WHO WANTS TO BE IN THE THICK OF DOWNTOWN, WITH GREAT FOOD\n" +
          "AND THE WHOLE BAY AREA A TRAIN OR A FERRY AWAY, WITHOUT EVER NEEDING A CAR.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY TENDERLOIN NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING THE TENDERLOIN HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass down a Tenderloin block (you, relaxed, not pitching)", "A quiet look up toward Nob Hill", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the theater marquees, the Little Saigon corridor, historic SRO facades, and street life in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the station entrances, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Tenderloin page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Tenderloin + Civic Center + Union Square in one downtown loop.",
  },
"Civic Center": {
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Civic%20Center&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Civic Center)",
    route: {
      // Route stays ENTIRELY within the Civic Center boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "City Hall & Civic Center Plaza", note: "Start — the gilded Beaux-Arts dome over the formal plaza", coord: [-122.4189, 37.7790] },
        { n: 2, name: "War Memorial Opera House & Davies Symphony Hall", note: "The performing-arts heart of the city on Van Ness", coord: [-122.4205, 37.7782] },
        { n: 3, name: "Asian Art Museum / old Main Library", note: "The grand 1917 library building, now the Asian Art Museum", coord: [-122.4156, 37.7795] },
        { n: 4, name: "United Nations Plaza", note: "The farmers-market space linking Civic Center to Market St", coord: [-122.4135, 37.7800] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON THE PLAZA IN FRONT OF CITY HALL, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE CIVIC CENTER? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Civic Center Plaza in the next", "You moving across the plaza toward City Hall into frame", "The gilded City Hall dome to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? CIVIC CENTER SITS IN THE DOWNTOWN CORE OF SAN FRANCISCO,\n" +
          "JUST WEST OF MARKET STREET, WITH HAYES VALLEY OVER ONE EDGE\n" +
          "AND THE TENDERLOIN RIGHT NEXT DOOR.\n" +
          "THIS IS THE CITY'S MONUMENTAL HEART — A FORMAL PLAZA RINGED BY GRAND BUILDINGS,\n" +
          "WITH CITY HALL'S GOLDEN DOME ANCHORING THE WHOLE ENSEMBLE.\n" +
          "AND HERE'S THE GOOD NEWS FOR EASE OF GETTING AROUND:\n" +
          "THIS IS A FLAT, LEVEL DOWNTOWN GRID, RUNNING ONLY ABOUT 40 TO 90 FEET UP.\n" +
          "THE WHOLE AREA IS LEVEL AND EASY TO GET AROUND —\n" +
          "WELL WITHIN WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "THERE'S NO STEEP CLIMB HERE THE WAY THERE IS UP ON THE CITY'S HILLS;\n" +
          "THE GROUND STAYS GENTLE FROM ONE END TO THE OTHER.\n" +
          "THE HOUSING IS MOSTLY APARTMENTS AND CONDOS AROUND THE EDGES OF THE CIVIC BUILDINGS,\n" +
          "AND ENTRIES VARY BUILDING BY BUILDING —\n" +
          "SOME ARE STEP-FREE LOBBIES, OTHERS HAVE A FEW STAIRS UP FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan across Civic Center Plaza toward City Hall", "Wide establishing shot showing the flat plaza and the ring of grand buildings", "Street-level look down a level downtown block"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. THIS IS THE GRANDEST BEAUX-ARTS CIVIC ENSEMBLE IN THE UNITED STATES.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "AFTER THE 1906 EARTHQUAKE AND FIRE LEVELED THE AREA,\n" +
          "SAN FRANCISCO REBUILT IT AS A 'CITY BEAUTIFUL' SHOWPIECE —\n" +
          "A UNIFIED COMPLEX OF MONUMENTAL BUILDINGS FRAMING A FORMAL PLAZA,\n" +
          "BUILT FOR THE 1915 ERA WHEN THE CITY ROSE FROM THE ASHES.\n" +
          "THE CENTERPIECE IS CITY HALL, OPENED IN 1915 —\n" +
          "ITS GOLDEN DOME STANDS TALLER THAN THE UNITED STATES CAPITOL IN WASHINGTON.\n" +
          "AROUND THE PLAZA YOU'LL FIND THE WAR MEMORIAL OPERA HOUSE,\n" +
          "DAVIES SYMPHONY HALL, AND THE ASIAN ART MUSEUM\n" +
          "IN THE OLD MAIN LIBRARY BUILDING,\n" +
          "PLUS THE BILL GRAHAM CIVIC AUDITORIUM ON THE PLAZA'S EDGE.\n" +
          "THIS BECAME THE PERFORMING-ARTS HEART OF THE CITY —\n" +
          "OPERA, SYMPHONY, AND BALLET ALL CALL THESE BLOCKS HOME.\n" +
          "SPEND TIME ON THIS PLAZA, AND YOU'RE STANDING IN THE CEREMONIAL CENTER\n" +
          "OF SAN FRANCISCO — THE PLACE THE CITY BUILT TO SHOW ITSELF OFF TO THE WORLD.",
        broll: ["City Hall's gilded dome from across the plaza", "The Opera House and Davies Symphony Hall facades on Van Ness", "The Asian Art Museum / old Main Library exterior"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THAT GILDED DOME ON CITY HALL RISES ABOUT 301 FEET —\n" +
          "HIGHER THAN THE U.S. CAPITOL DOME IN WASHINGTON.\n" +
          "AND THE UNITED NATIONS WAS BORN RIGHT HERE:\n" +
          "IN 1945, DELEGATES OF FIFTY NATIONS MET ON THESE BLOCKS,\n" +
          "ADOPTED THE U-N CHARTER AT THE OPERA HOUSE,\n" +
          "AND SIGNED IT NEXT DOOR AT THE WAR MEMORIAL'S HERBST THEATRE.\n" +
          "THE ASIAN ART MUSEUM, IN THE OLD MAIN LIBRARY,\n" +
          "HOLDS ONE OF THE WORLD'S GREAT COLLECTIONS OF ASIAN ART.\n" +
          "AND THE GRAND MAIN LIBRARY THAT REPLACED IT, ACROSS THE PLAZA,\n" +
          "OPENED IN 1996 WITH OVER 376,000 SQUARE FEET ACROSS SEVEN FLOORS.\n" +
          "THIS IS A NEIGHBORHOOD WHERE THE BUILDINGS THEMSELVES MADE HISTORY.",
        broll: ["City Hall dome tight shot", "The Opera House / Herbst Theatre facade", "The Asian Art Museum entrance"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "CIVIC CENTER SITS IN THE DOWNTOWN CORE, AND IT'S GENERALLY ONE OF THE SUNNIER,\n" +
          "MILDER POCKETS OF THE CITY.\n" +
          "WHILE THE AVENUES OUT WEST DISAPPEAR INTO SUMMER FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND CIVIC CENTER IS ONE OF THE EASIEST PLACES\n" +
          "IN THE ENTIRE CITY TO LIVE WITHOUT A CAR — THE TRANSIT HERE IS EXCEPTIONAL.\n" +
          "RIGHT UNDER MY FEET IS CIVIC CENTER STATION — BART AND MUNI METRO TOGETHER,\n" +
          "WITH THE FULL METRO LINEUP: THE J, K, L, M, N, AND T LINES.\n" +
          "VAN NESS IS RIGHT HERE WITH THE VAN NESS BUS RAPID TRANSIT,\n" +
          "AND MANY MORE MUNI BUSES THREAD THROUGH ON MARKET, VAN NESS, AND POLK.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT TWO MILES NORTHEAST,\n" +
          "A QUICK RIDE ON THE METRO TO EMBARCADERO,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? TAKE BART RIGHT FROM CIVIC CENTER —\n" +
          "DOWNTOWN OAKLAND IS ABOUT TWENTY MINUTES DOOR TO PLATFORM.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THE SAME.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE MUNI TO THE CALTRAIN DEPOT\n" +
          "AT 4TH AND KING, AND CALTRAIN RUNS DOWN TO PALO ALTO IN ABOUT FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: BART, THE FULL MUNI METRO, BUSES, FERRIES, AND THREE BRIDGES —\n" +
          "ALL WITHOUT OWNING A CAR.",
        broll: [
          "Civic Center Station entrance / escalator down; a Muni Metro train",
          "Embarcadero Station + the Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: Civic Center → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS FIRST: CIVIC CENTER SITS INLAND, WELL BACK FROM THE BAY,\n" +
          "SO IT IS NOT IN A TSUNAMI HAZARD ZONE — CROSS THAT WORRY OFF THE LIST.\n" +
          "THE OTHER NOTE IS SEISMIC: PARTS OF THIS DOWNTOWN AREA\n" +
          "SIT ON MADE GROUND AND DO FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THAT'S STANDARD FOR THIS PART OF THE CITY, AND IT'S SOMETHING\n" +
          "EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing across the flat plaza", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "CIVIC CENTER PUTS YOU NEXT TO ONE OF THE CITY'S RICHEST DINING AND NIGHTLIFE EDGES —\n" +
          "COFFEE, BRUNCH, CLASSIC DINNER SPOTS, AND WINE BARS JUST OFF THE PLAZA,\n" +
          "PLUS A NIGHT AT THE OPERA, THE SYMPHONY, OR THE BALLET RIGHT OUTSIDE YOUR DOOR.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY CIVIC CENTER DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A CULTURE-AND-TRANSIT, LEAVE-THE-CAR-HOME KIND OF PLACE.",
        broll: ["Café tables; a busy restaurant window at dusk", "The Opera House or Symphony Hall lit up at night", "People crossing the plaza in the evening"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: CIVIC CENTER IS MOSTLY APARTMENTS AND CONDOS\n" +
          "AROUND THE EDGES OF THE GRAND CIVIC BUILDINGS —\n" +
          "FROM OLDER APARTMENT BUILDINGS NEAR THE PLAZA\n" +
          "TO NEWER CONDO TOWERS AND CONVERTED UNITS NEARER MARKET STREET.\n" +
          "IT RUNS FROM A FIRST CONDO OR PIED-À-TERRE TO A LIGHT-FILLED HIGHER-FLOOR UNIT.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR CIVIC CENTER ON MY SITE —\n" +
          "CURRENT MEDIANS FOR THE CONDO AND APARTMENT MARKET, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A condo building entry, an older apartment lobby, a modern tower", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN CIVIC CENTER?\n" +
          "SOMEONE WHO WANTS CULTURE, EASE, AND THE WHOLE BAY AREA\n" +
          "A TRAIN OR A FERRY AWAY, WITHOUT EVER NEEDING A CAR.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY CIVIC CENTER NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING CIVIC CENTER HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass across the plaza (you, relaxed, not pitching)", "A quiet look up at the lit City Hall dome", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the City Hall dome, the Opera House and Symphony Hall, the museum, the plaza, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the station entrance, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Civic Center page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Civic Center + Hayes Valley + Tenderloin in one morning loop.",
  },
"Fishermans Wharf": {
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Fishermans%20Wharf&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Fishermans Wharf)",
    route: {
      // Route stays ENTIRELY within the Fishermans Wharf boundary (verified
      // against the neighborhood polygon). Coords approximate — I'll snap to the
      // sidewalk grid for the final cut.
      spots: [
        { n: 1, name: "Fish Alley & the fishing-boat harbor", note: "Start — the working crab fleet; the still-active heart of the Wharf", coord: [-122.4198, 37.8082] },
        { n: 2, name: "Hyde Street Pier — historic ships", note: "The square-rigger Balclutha and the maritime national park fleet", coord: [-122.4153, 37.8083] },
        { n: 3, name: "Cable-car turnaround at Hyde & Beach", note: "The Powell-Hyde line spins around at the bay's edge", coord: [-122.4203, 37.8061] },
        { n: 4, name: "Ghirardelli Square", note: "The 1852 chocolate factory, an early adaptive-reuse landmark", coord: [-122.4191, 37.8066] },
        { n: 5, name: "PIER 39 & the sea lions", note: "The K-Dock haul-out — barking sea lions since 1990", coord: [-122.4098, 37.8087] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M DOWN BY THE BOATS AT FISHERMAN'S WHARF, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE FISHERMAN'S WHARF? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, the sunny harbor in the next", "You moving along the Jefferson St waterfront into frame", "The fishing boats / a wind ripple on the water to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 190,
        script:
          "FIRST — WHERE ARE WE? FISHERMAN'S WHARF SITS RIGHT ON SAN FRANCISCO'S\n" +
          "NORTHERN BAYFRONT, AT THE TOP EDGE OF THE CITY,\n" +
          "WITH RUSSIAN HILL AND NORTH BEACH RISING BEHIND IT\n" +
          "AND THE BAY — ALCATRAZ, ANGEL ISLAND — SPREAD OUT IN FRONT.\n" +
          "THE SPINE IS JEFFERSON STREET, RUNNING THE WATERFRONT\n" +
          "FROM GHIRARDELLI SQUARE IN THE WEST TO PIER 39 IN THE EAST.\n" +
          "THIS IS WATER-LEVEL GROUND — ROUGHLY ZERO TO A HUNDRED FEET UP —\n" +
          "AND THE WATERFRONT ITSELF IS FLAT AND LEVEL, EASY TO GET AROUND,\n" +
          "COMFORTABLY WITHIN WHAT THE A-D-A CONSIDERS AN ACCESSIBLE GRADE — ABOUT FIVE PERCENT —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "ONE HONEST THING TO KNOW UP FRONT: THIS IS FIRST AND FOREMOST\n" +
          "A DESTINATION DISTRICT, NOT A BIG RESIDENTIAL ONE.\n" +
          "HOUSING HERE IS LIMITED — MOSTLY A FEW CONDOS AND APARTMENTS\n" +
          "TUCKED BEHIND THE TOURIST FRONTAGE — SO IF YOU WANT TO LIVE AT THE WATER'S EDGE,\n" +
          "THE OPTIONS ARE SPECIAL BUT FEW. THE STREETS CLIMB FAST ONCE YOU HEAD INLAND.",
        broll: ["Slow pan along Jefferson St; the harbor and the bay behind", "Wide establishing shot: the waterfront with Russian Hill rising behind", "A condo / apartment building tucked behind the shops"],
      },
      {
        label: "2 · HISTORY",
        words: 195,
        script:
          "NOW THE STORY. FISHERMAN'S WHARF HAS BEEN A WORKING ITALIAN FISHING HARBOR\n" +
          "SINCE THE 1800s — AND A SMALL CRAB FLEET STILL WORKS THESE WATERS TODAY.\n" +
          "ALL OF THIS BAYFRONT WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE\n" +
          "LONG BEFORE ANY PIER WAS DRIVEN INTO THE MUD.\n" +
          "IN THE LATE 1800s, ITALIAN IMMIGRANTS — MANY FROM GENOA —\n" +
          "LAUNCHED THEIR BOATS HERE TO CHASE HERRING AND DUNGENESS CRAB,\n" +
          "SELLING THE CATCH FROM STALLS ALONG THE PIER.\n" +
          "IT WAS RIGHT HERE THAT GENOESE FISHERMEN INVENTED CIOPPINO,\n" +
          "THE COMMUNAL SEAFOOD STEW.\n" +
          "AFTER THE 1906 EARTHQUAKE THE AREA WAS REBUILT,\n" +
          "AND OVER THE 20TH CENTURY THE SHRINKING FLEET GAVE WAY\n" +
          "TO A WATERFRONT OF CRAB STANDS, RESTAURANTS, AND SHOPS.\n" +
          "TODAY YOU CAN STILL SEE THE TWO LAYERS SIDE BY SIDE —\n" +
          "A REAL COMMERCIAL CRAB FLEET WORKING ALONGSIDE\n" +
          "ONE OF THE MOST-VISITED WATERFRONTS IN AMERICA.\n" +
          "SPEND TIME DOWN BY FISH ALLEY EARLY IN THE MORNING,\n" +
          "AND YOU'RE STANDING IN A LIVING, WORKING PIECE OF THE CITY'S ORIGINS.",
        broll: ["The working fishing boats at Fish Alley", "Steaming Dungeness crab pots on the sidewalk", "Old maritime photos / a felucca-style hull for contrast"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 165,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THOSE BARKING SEA LIONS AT PIER 39 ARE NEWCOMERS —\n" +
          "THEY FIRST HAULED OUT ON THE K-DOCK AFTER THE 1989 LOMA PRIETA QUAKE,\n" +
          "AND BY 1990 HUNDREDS HAD MOVED IN FOR GOOD.\n" +
          "OVER AT THE WEST END, GHIRARDELLI SQUARE WAS A REAL CHOCOLATE FACTORY,\n" +
          "WITH ROOTS BACK TO 1852 — AND IN THE 1960s IT BECAME\n" +
          "ONE OF THE FIRST BIG ADAPTIVE-REUSE PROJECTS IN THE COUNTRY.\n" +
          "ALONG HYDE STREET PIER, THE HISTORIC SHIPS ARE A FLOATING MUSEUM —\n" +
          "INCLUDING A SQUARE-RIGGED CARGO SHIP YOU CAN STEP ABOARD.\n" +
          "AND BOTH CABLE-CAR LINES — POWELL-HYDE AND POWELL-MASON —\n" +
          "SPIN AROUND RIGHT HERE AT THE BAY'S EDGE.\n" +
          "ONE MORE: THE IRISH COFFEE YOU SEE ALL OVER AMERICA\n" +
          "MADE ITS U.S. DEBUT JUST OFF THE HYDE STREET TURNAROUND, BACK IN 1952.",
        broll: ["Sea lions tight on the K-Dock", "Ghirardelli Square sign", "The Balclutha's masts at Hyde Street Pier; a cable car turning"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "FISHERMAN'S WHARF IS RIGHT ON THE BAY, SO IT TENDS TO BE SUNNIER\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND THE WHARF IS ONE OF THE EASIEST PLACES\n" +
          "IN THE WHOLE CITY TO LIVE WITHOUT A CAR.\n" +
          "TWO CABLE-CAR LINES TERMINATE RIGHT HERE — THE POWELL-HYDE\n" +
          "AND THE POWELL-MASON — CLANGING UP AND OVER THE HILLS DOWNTOWN.\n" +
          "THE F-LINE HISTORIC STREETCAR RUNS ALONG THE EMBARCADERO TO THE FERRY BUILDING,\n" +
          "AND THE 8, 30, 47, AND 49 BUSES THREAD THROUGH AND OUT OF THE NEIGHBORHOOD.\n" +
          "NEAREST BART AND MUNI METRO IS EMBARCADERO STATION, A SHORT HOP DOWN THE F-LINE.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT A MILE AND A HALF SOUTHEAST,\n" +
          "AN EASY RIDE ON THE F-LINE STREETCAR ALONG THE WATER —\n" +
          "AND THAT'S YOUR GATEWAY TO EVERYTHING ON THE BAY.\n" +
          "GOING TO THE EAST BAY? FROM EMBARCADERO, TAKE BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT TWENTY MINUTES DOOR TO PLATFORM.\n" +
          "HEADING NORTH TO MARIN? FROM THE FERRY BUILDING,\n" +
          "THE LARKSPUR AND SAUSALITO FERRIES CROSS IN ABOUT THIRTY MINUTES ON THE WATER.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE MUNI FROM EMBARCADERO\n" +
          "TO THE CALTRAIN DEPOT AT 4TH AND KING, AND CALTRAIN RUNS DOWN\n" +
          "TO PALO ALTO IN ABOUT FIFTY MINUTES — OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: CABLE CARS, FERRIES, AND RAIL — ALL WITHOUT OWNING A CAR.",
        broll: [
          "A cable car turning at Hyde & Beach; an F-line streetcar on the Embarcadero",
          "Embarcadero Station + the Ferry Building / a departing ferry",
          "A BART train; a Caltrain at 4th & King; ferries crossing toward Marin",
          "Simple motion-graphic map: the Wharf → Oakland / Marin / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        words: 120,
        script:
          "TWO HONEST NOTES ON THE GROUND ITSELF — AND I'LL GIVE THEM TO YOU STRAIGHT.\n" +
          "THIS IS LOW BAYFRONT LAND, AND PARTS OF THE WHARF SIT ON FILL —\n" +
          "GROUND THAT WAS ADDED OUT INTO THE BAY OVER THE YEARS.\n" +
          "BECAUSE OF THAT, IT DOES FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE\n" +
          "FOR LIQUEFACTION — THAT'S STANDARD FOR THE CITY'S FILLED WATERFRONT,\n" +
          "AND IT'S SOMETHING EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "AND BECAUSE IT'S RIGHT AT THE WATER, IT ALSO SITS IN A TSUNAMI HAZARD ZONE.\n" +
          "NEITHER OF THESE IS A REASON TO PANIC — THEY'RE JUST THINGS TO KNOW.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the waterline / the piers out over the water", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "THE WHARF IS A WATERFRONT FULL OF SEAFOOD —\n" +
          "CRAB STANDS, SOURDOUGH, CLASSIC SIT-DOWN FISH HOUSES,\n" +
          "AND A HANDFUL OF LANDMARK SPOTS WITH REAL HISTORY ON THE BAY.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY FISHERMAN'S WHARF DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A LIVELY, RIGHT-ON-THE-WATER DISTRICT,\n" +
          "BUSY WITH VISITORS BY DAY AND QUIETER ONCE THE CROWDS THIN OUT.",
        broll: ["Steaming crab pots; a busy seafood window at dusk", "Sourdough bakery / café tables on the waterfront", "A classic neon sign on the pier (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: FISHERMAN'S WHARF IS FIRST AND FOREMOST A DESTINATION DISTRICT,\n" +
          "SO LIVING HERE IS A SPECIAL CASE — THE SUPPLY IS VERY LIMITED.\n" +
          "WHAT YOU FIND IS MOSTLY CONDOS AND APARTMENTS TUCKED IN AND AROUND\n" +
          "THE EDGES OF THE WATERFRONT, BEHIND THE SHOPS AND THE PIERS.\n" +
          "THESE ARE RARE, OFTEN VIEW-DRIVEN HOMES RATHER THAN A DEEP, EASY MARKET.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES —\n" +
          "AND WITH SO FEW SALES, IT MOVES A LOT.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR FISHERMAN'S WHARF ON MY SITE,\n" +
          "RIGHT UP TO TODAY. THE LINK IS BELOW —\n" +
          "AND WITH A MARKET THIS THIN, THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A condo / apartment building near the waterfront", "A bay-view balcony or window", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 125,
        script:
          "SO — WHO BELONGS AT FISHERMAN'S WHARF?\n" +
          "SOMEONE WHO WANTS TO WAKE UP RIGHT ON THE BAY,\n" +
          "WITH CABLE CARS AND FERRIES AT THE DOOR AND THE WATER OUT THE WINDOW —\n" +
          "AND WHO'S OKAY WITH A RARE, SPECIAL KIND OF HOME IN A BUSY DISTRICT.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY FISHERMANS WHARF NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING FISHERMAN'S WHARF HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass along the waterfront (you, relaxed, not pitching)", "A quiet look out across the bay toward Alcatraz", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the fishing boats, the historic ships, the sea lions, cable-car turnaround, and the bay in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the cable-car turnaround, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Fishermans Wharf page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Fishermans Wharf + North Beach + Russian Hill in one waterfront loop.",
  },
"Inner Sunset": {
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Inner%20Sunset&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Inner Sunset)",
    route: {
      // Route stays ENTIRELY within the Inner Sunset boundary (verified against
      // the neighborhood polygon). Coords approximate — I'll snap to the
      // sidewalk grid for the final cut.
      spots: [
        { n: 1, name: "9th Ave & Irving — the food village", note: "Start — the buzzing global-food corner, the heart of the neighborhood", coord: [-122.4663, 37.7639] },
        { n: 2, name: "9th Ave & Lincoln — Golden Gate Park gateway", note: "The park's edge: the de Young, Academy of Sciences, the Music Concourse just beyond", coord: [-122.4664, 37.7657] },
        { n: 3, name: "San Francisco Botanical Garden entrance", note: "9th Ave gate into the Botanical Garden along the park's southern rim", coord: [-122.4684, 37.7654] },
        { n: 4, name: "Irving St & 7th Ave — a flat avenue block", note: "The level Irving core: classic Sunset flats and cafes, easy to get around", coord: [-122.4640, 37.7638] },
        { n: 5, name: "Kirkham & 7th Ave — the rise toward Forest Hill", note: "Where the flat avenues start climbing south toward Forest Hill", coord: [-122.4641, 37.7598] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M AT 9TH AND IRVING, AND THE FOG IS ROLLING IN —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE THE INNER SUNSET? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, the 9th & Irving strip in the next", "You moving up 9th Ave into frame", "Golden Gate Park's leafy edge to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? THE INNER SUNSET SITS ON THE CITY'S WEST SIDE,\n" +
          "PRESSED RIGHT UP AGAINST THE SOUTHERN EDGE OF GOLDEN GATE PARK,\n" +
          "WITH UCSF AND PARNASSUS HEIGHTS ON THE HILL ABOVE,\n" +
          "AND THE FLAT, SANDY AVENUES OF THE SUNSET RUNNING OUT TO THE WEST.\n" +
          "THE HEART OF THE NEIGHBORHOOD IS THE 9TH AVENUE AND IRVING STREET VILLAGE —\n" +
          "ONE OF THE CITY'S BEST GLOBAL-FOOD AND CAFE CORNERS.\n" +
          "THE NUMBERS RUN ROUGHLY 220 TO 480 FEET,\n" +
          "BUT DON'T LET THAT FOOL YOU: THE IRVING AND 9TH CORE IS FLAT AND LEVEL —\n" +
          "EASY TO GET AROUND, WELL WITHIN WHAT THE A-D-A CONSIDERS\n" +
          "AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "IT'S ONLY AS YOU HEAD SOUTH, RISING TOWARD FOREST HILL,\n" +
          "THAT THE GRADE PICKS UP AND THE BLOCKS START TO CLIMB.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE AVENUE FLATS ARE YOUR FRIEND; THE SOUTHERN EDGE IS A CLIMB.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY OF THESE CLASSIC SUNSET HOUSES SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan up 9th Ave; street signs at 9th & Irving", "Wide establishing shot showing the park edge + the rise toward Forest Hill", "A cross-street climbing south (show the grade picking up)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. THIS WAS ALL THE 'OUTSIDE LANDS' —\n" +
          "OPEN SAND DUNES ON THE CITY'S FAR WESTERN EDGE,\n" +
          "DOTTED WITH DAIRIES, ROADHOUSES, AND EVEN DYNAMITE WORKS.\n" +
          "ALL OF IT WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "DEVELOPMENT TOOK HOLD IN 1887, WHEN ENTREPRENEUR AURELIUS BUCKINGHAM\n" +
          "BEGAN BUILDING NEAR 5TH AVENUE AND LINCOLN WAY,\n" +
          "AND IT ACCELERATED WITH THE 1894 CALIFORNIA MIDWINTER EXPOSITION,\n" +
          "STAGED RIGHT NEXT DOOR IN GOLDEN GATE PARK.\n" +
          "IN 1897, UCSF PLANTED ITS MEDICAL CAMPUS ON THE HILL ABOVE —\n" +
          "A PRESENCE THAT STILL SHAPES THE NEIGHBORHOOD TODAY.\n" +
          "BUT THE REAL CHANGE CAME WITH THE STREETCAR.\n" +
          "WHEN THE SUNSET TUNNEL AND THE N-JUDAH LINE OPENED —\n" +
          "MAYOR 'SUNNY JIM' ROLPH DROVE THE FIRST CAR IN 1928 —\n" +
          "THE ONCE-REMOTE OUTSIDE LANDS WERE FINALLY TIED TO DOWNTOWN,\n" +
          "AND THE BLOCKS FILLED IN WITH HOMES.\n" +
          "SPEND TIME ON THESE AVENUES, AND YOU CAN STILL FEEL THAT HISTORY —\n" +
          "A QUIET RESIDENTIAL GRID THAT GREW UP AROUND A PARK, A CAMPUS, AND A STREETCAR.",
        broll: ["Classic Sunset flats and avenue blocks", "The N-Judah running along Irving", "Golden Gate Park's southern edge / the Music Concourse"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THE INNER SUNSET IS BASICALLY GOLDEN GATE PARK'S FRONT PORCH —\n" +
          "THE DE YOUNG MUSEUM, THE CALIFORNIA ACADEMY OF SCIENCES,\n" +
          "THE SAN FRANCISCO BOTANICAL GARDEN, AND THE MUSIC CONCOURSE\n" +
          "ARE ALL RIGHT THERE, JUST OFF 9TH AVENUE.\n" +
          "THAT LITTLE 9TH AND IRVING STRIP PUNCHES WAY ABOVE ITS WEIGHT —\n" +
          "IT'S LONG BEEN ONE OF THE CITY'S MOST BELOVED FOOD AND CAFE CORRIDORS.\n" +
          "AND ON LINCOLN WAY SITS THE LITTLE SHAMROCK,\n" +
          "POURING DRINKS SINCE 1893 — ONE OF SAN FRANCISCO'S\n" +
          "OLDEST CONTINUOUSLY OPERATING BARS.\n" +
          "THE WHOLE NEIGHBORHOOD REALLY OWES ITS START TO A WORLD'S FAIR —\n" +
          "THE 1894 MIDWINTER EXPOSITION NEXT DOOR IN THE PARK\n" +
          "DREW THE CROWDS THAT FIRST PUT THESE SANDY BLOCKS ON THE MAP.",
        broll: ["The de Young / Academy of Sciences off 9th Ave", "The 9th & Irving food strip, busy", "The Botanical Garden gate; the Music Concourse"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "LET'S BE HONEST: THE INNER SUNSET IS A SUNSET-DISTRICT NEIGHBORHOOD,\n" +
          "AND THAT MEANS REAL SUMMER FOG.\n" +
          "WHEN THE MARINE LAYER PUSHES IN OFF THE OCEAN,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND THE INNER SUNSET IS ONE OF THE EASIEST PLACES\n" +
          "IN THE WHOLE CITY TO LIVE WITHOUT A CAR.\n" +
          "THE STANDOUT IS THE N-JUDAH MUNI METRO, RUNNING RIGHT ALONG IRVING AND 9TH,\n" +
          "CARRYING YOU STRAIGHT DOWNTOWN — AND ALL THE WAY TO THE BALLPARK.\n" +
          "ON TOP OF THAT YOU'VE GOT THE 6, 43, 44, 7, AND 28 BUSES\n" +
          "THREADING THROUGH THE AVENUES AND OVER THE HILLS.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT FIVE MILES NORTHEAST,\n" +
          "AND THE N-JUDAH TAKES YOU TO EMBARCADERO,\n" +
          "WHICH IS YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? FROM DOWNTOWN, HOP BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES DOOR TO PLATFORM.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          ...
          "BOTTOM LINE: WATER, RAIL, AND THREE BRIDGES — ALL WITHOUT OWNING A CAR.",
        broll: [
          "N-Judah on Irving; the 9th & Irving stop",
          "Embarcadero Station + the Ferry Building / a departing ferry",
          "A BART train; the Bay Bridge; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: Inner Sunset → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS FIRST: THE INNER SUNSET SITS INLAND OF THE BEACH,\n" +
          "WELL BACK FROM THE OCEAN, SO IT IS NOT IN A TSUNAMI HAZARD ZONE —\n" +
          "CROSS THAT WORRY OFF THE LIST.\n" +
          "THE OTHER NOTE IS THE SANDY GROUND THESE AVENUES ARE BUILT ON.\n" +
          "PARTS OF THE NEIGHBORHOOD DO FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THAT'S COMMON FOR THE CITY'S SANDIER WEST-SIDE BLOCKS,\n" +
          "AND IT'S SOMETHING EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing along a flat sandy avenue", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "THE INNER SUNSET'S 9TH AND IRVING STRIP IS ONE OF THE BEST\n" +
          "FOOD AND CAFE CORNERS IN THE WHOLE CITY —\n" +
          "GLOBAL EATS, BAKERIES, COFFEE, AND A FEW LANDMARK BARS WITH REAL HISTORY.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY INNER SUNSET DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A RIGHT-OUTSIDE-YOUR-DOOR, LEAVE-THE-CAR-HOME KIND OF PLACE,\n" +
          "WITH A GREAT PARK AT ONE END OF THE BLOCK.",
        broll: ["Café tables along 9th Ave; a busy restaurant window at dusk", "The food strip at night; people on the sidewalk", "A classic bar sign (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: THE INNER SUNSET IS CLASSIC WEST-SIDE SAN FRANCISCO —\n" +
          "EDWARDIAN AND MARINA-STYLE FLATS, SINGLE-FAMILY SUNSET HOMES\n" +
          "ON THE QUIETER AVENUE BLOCKS, AND CONDOS NEARER THE 9TH & IRVING CORE.\n" +
          "IT RUNS FROM A FIRST CONDO TO A FULLY UPDATED FAMILY HOUSE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR THE INNER SUNSET ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A Sunset flats building, a single-family house, a modern condo entry", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN THE INNER SUNSET?\n" +
          "SOMEONE WHO WANTS A GREAT PARK AT THE DOORSTEP, A REAL FOOD SCENE,\n" +
          "AND THE WHOLE BAY AREA A TRAIN OR A FERRY AWAY, WITHOUT EVER NEEDING A CAR.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY INNER SUNSET NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING THE INNER SUNSET HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass down 9th Ave (you, relaxed, not pitching)", "A quiet look toward Golden Gate Park's edge", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the food strip, the park gateway, the Botanical Garden gate, avenue blocks, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the N-Judah stop, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Inner Sunset page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Inner Sunset + Cole Valley + Golden Gate Heights in one morning loop.",
  },
"Outer Sunset": {
    aka: "the Outside Lands",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Outer%20Sunset&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Outer Sunset)",
    route: {
      // Route stays ENTIRELY within the Outer Sunset boundary (verified against
      // the neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Judah St & La Playa — N-Judah terminus", note: "Start — the N-Judah ends here, a block from the ocean; café strip", coord: [-122.5085, 37.7603] },
        { n: 2, name: "Judah St cafe row (~40th–46th Ave)", note: "Trouble/Outerlands-style café & surf-shop stretch", coord: [-122.5015, 37.7601] },
        { n: 3, name: "Flat avenue residential block (45th Ave & Kirkham)", note: "Classic Doelger row houses on a level, easy-to-explore block", coord: [-122.5050, 37.7585] },
        { n: 4, name: "Noriega St surf-culture corner", note: "Beachside cafes, board shops, the mellow Outer Sunset vibe", coord: [-122.5040, 37.7531] },
        { n: 5, name: "Great Highway & Ocean Beach edge", note: "The Pacific edge — fog rolling in off the water", coord: [-122.5095, 37.7548] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M A FEW BLOCKS FROM OCEAN BEACH, AND THE FOG IS ROLLING IN OFF THE PACIFIC —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE THE OUTER SUNSET? LET'S GO.",
        broll: ["Two-shot idea: a sunny inland ridge in one frame, foggy Outer Sunset avenue in the next", "You walking up Judah St into frame with the fog behind", "Ocean Beach / the Great Highway edge to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 200,
        script:
          "FIRST — WHERE ARE WE? THE OUTER SUNSET SITS AT THE FAR WESTERN EDGE\n" +
          "OF SAN FRANCISCO, RIGHT UP AGAINST OCEAN BEACH AND THE PACIFIC,\n" +
          "WITH GOLDEN GATE PARK ALONG THE NORTH AND THE AVENUES MARCHING\n" +
          "STRAIGHT DOWN TO THE WATER.\n" +
          "THIS IS A GRID — NUMBERED AVENUES CROSSING NAMED STREETS,\n" +
          "JUDAH, NORIEGA, TARAVAL — LAID OUT SIMPLE AND EASY TO READ.\n" +
          "AND HERE'S THE KEY THING: THE AVENUE GRID IS FLAT AND LEVEL.\n" +
          "ACROSS THE HEART OF THE NEIGHBORHOOD, GETTING AROUND IS EASY —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR,\n" +
          "COMFORTABLY WITHIN WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "THE ONE EXCEPTION IS THE FAR EASTERN EDGE, UP TOWARD THE HILLS,\n" +
          "WHERE THE LAND BEGINS TO RISE — BUT THE CORE WHERE MOST PEOPLE LIVE\n" +
          "IS AS FLAT AND EVEN AS IT GETS IN THIS CITY.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY OF THESE CLASSIC ROW HOUSES SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "OFTEN OVER A GARAGE, SO IF STEP-FREE ENTRY IS A MUST,\n" +
          "IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan down a numbered avenue toward the ocean", "Wide establishing shot: the flat avenue grid meeting the beach", "A row-house entry up a flight of stairs over the garage"],
      },
      {
        label: "2 · HISTORY",
        words: 195,
        script:
          "NOW THE STORY. THESE STREETS WERE ONCE THE WINDSWEPT SAND DUNES\n" +
          "OF THE 'OUTSIDE LANDS' — SAN FRANCISCO'S FAR WEST SIDE,\n" +
          "FOR A LONG TIME CONSIDERED TOO REMOTE AND TOO SANDY TO SETTLE.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "THE PARK AND OCEAN RAILROAD STARTED BRINGING WEEKEND CROWDS\n" +
          "OUT TO OCEAN BEACH IN 1883, BUT THE DUNES STAYED MOSTLY EMPTY\n" +
          "UNTIL THE 1920s AND 30s.\n" +
          "THEN CAME THE BUILDERS. USING NEW FHA LOANS, DEVELOPERS LIKE HENRY DOELGER\n" +
          "PUT UP ROW AFTER ROW OF AFFORDABLE STUCCO SINGLE-FAMILY HOMES.\n" +
          "FROM 1934 TO 1941, DOELGER WAS THE LARGEST HOMEBUILDER IN THE COUNTRY —\n" +
          "ROUGHLY TWO HOUSES A DAY —\n" +
          "AND BY JUST AFTER WORLD WAR TWO, THE DUNES HAD FILLED\n" +
          "WITH A SEA OF THOSE ROW HOUSES.\n" +
          "WHAT GREW UP ON TOP OF ALL THAT SAND IS THE NEIGHBORHOOD YOU SEE NOW:\n" +
          "A FOGGY, LAID-BACK SURF-AND-BEACH DISTRICT ALONG OCEAN BEACH,\n" +
          "WHERE LIFE MOVES AT A MELLOW PACE.",
        broll: ["Archival-style row of identical stucco row houses", "Ocean Beach / the old Great Highway", "A long avenue running straight to the water"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THE OUTER SUNSET FRONTS OCEAN BEACH — ONE OF THE MOST POWERFUL\n" +
          "AND CHALLENGING SURF BREAKS ON THE WHOLE WEST COAST.\n" +
          "THIS IS A REAL SURF NEIGHBORHOOD, WETSUITS AND BOARDS AND ALL.\n" +
          "MUCH OF THE HOUSING IS HENRY DOELGER'S WORK — AT HIS PEAK\n" +
          "THE NATION'S BIGGEST HOMEBUILDER, FINISHING ABOUT TWO STUCCO HOUSES A DAY.\n" +
          "AND THERE'S A NEW CHAPTER: IN APRIL 2025 THE 77-ACRE, CAR-FREE\n" +
          "SUNSET DUNES PARK OPENED ALONG THE FORMER UPPER GREAT HIGHWAY —\n" +
          "CALIFORNIA'S LARGEST PEDESTRIANIZATION PROJECT.\n" +
          "THE BIGGEST SHIFT, THOUGH, IS THE FEEL: A RECENT WAVE OF BELOVED CAFES —\n" +
          "THINK JAVA BEACH, THE LITTLE COFFEE-AND-SURF SPOTS ALONG JUDAH —\n" +
          "TURNED A SLEEPY EDGE OF THE CITY INTO ONE OF ITS MOST CHARMING,\n" +
          "SLOWER-PACED CORNERS.",
        broll: ["Surfers crossing the Great Highway with boards", "A line of Doelger row houses", "A busy little café on Judah St"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 110,
        script:
          "QUICK WORD ON WEATHER — AND HERE I HAVE TO BE STRAIGHT WITH YOU,\n" +
          "BECAUSE THIS IS THE DEFINING FEATURE OF THE OUTER SUNSET.\n" +
          "THIS IS ONE OF THE FOGGIEST, COOLEST, WINDIEST PARTS OF THE WHOLE CITY.\n" +
          "RIGHT ON THE OCEAN, THE SUMMER FOG ROLLS IN OFF THE PACIFIC\n" +
          "AND CAN SIT FOR DAYS — WHILE NEIGHBORHOODS JUST A FEW MILES INLAND\n" +
          "ARE BASKING IN SUN.\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. THE OUTER SUNSET IS FAR FROM DOWNTOWN —\n" +
          "BUT IT HAS A REAL LIFELINE: THE N-JUDAH.\n" +
          "THE N-JUDAH MUNI METRO RUNS RIGHT ALONG JUDAH STREET,\n" +
          "FROM OCEAN BEACH STRAIGHT THROUGH TO DOWNTOWN —\n" +
          "AND GIVEN HOW FAR OUT WE ARE, THAT ONE-SEAT RIDE IS A STANDOUT.\n" +
          "THE L-TARAVAL SERVES THE SOUTHERN AVENUES,\n" +
          "AND THE 18, 29, AND 7 BUSES FILL IN THE REST OF THE GRID.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT SIX MILES NORTHEAST — IT'S FAR,\n" +
          "SO THE N-JUDAH IS YOUR LIFELINE: TAKE IT DOWNTOWN,\n" +
          "ROUGHLY FORTY-FIVE MINUTES TO THE EMBARCADERO,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? TAKE THE N-JUDAH DOWNTOWN, THEN BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES FROM THE EMBARCADERO.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE THE N-JUDAH TO THE CALTRAIN DEPOT\n" +
          "AT 4TH AND KING, AND CALTRAIN RUNS DOWN TO PALO ALTO IN ABOUT FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: YOU'RE OUT ON THE EDGE, BUT THE N-JUDAH KEEPS YOU\n" +
          "CONNECTED TO WATER, RAIL, AND BRIDGES — WITHOUT OWNING A CAR.",
        broll: [
          "An N-Judah train running along Judah St toward the ocean",
          "Embarcadero Station + the Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: Outer Sunset → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "REMEMBER, ALL OF THIS WAS BUILT ON FORMER SAND DUNES RIGHT BY THE OCEAN —\n" +
          "SO THE GROUND HERE IS SANDY, AND THAT'S WORTH KNOWING.\n" +
          "PARTS OF THE NEIGHBORHOOD FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THAT'S COMMON FOR SANDY, LOW-LYING GROUND, AND IT'S SOMETHING\n" +
          "EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "AND BECAUSE WE'RE RIGHT ON OCEAN BEACH, THE WESTERN EDGE\n" +
          "DOES SIT IN A MAPPED TSUNAMI HAZARD ZONE — CALMLY, IT'S JUST A FACT\n" +
          "OF LIVING AT THE PACIFIC'S EDGE, AND IT'S GOOD TO PLAN AROUND.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing toward the beach and the sandy ground", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "THE OUTER SUNSET HAS QUIETLY BECOME ONE OF THE CITY'S BEST FOOD-AND-COFFEE EDGES —\n" +
          "BEACHSIDE CAFES, BAKERIES, SURF-SHOP COFFEE BARS,\n" +
          "AND A HANDFUL OF DESTINATION RESTAURANTS ALONG JUDAH AND NORIEGA.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND CAFES RIGHT ON MY OUTER SUNSET DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A SLOW-MORNING, COFFEE-AFTER-THE-BEACH,\n" +
          "LEAVE-THE-CAR-HOME KIND OF PLACE.",
        broll: ["Café tables; a board-shop coffee bar window", "A bakery line on a foggy morning", "People with boards and coffees along Judah St"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: THE OUTER SUNSET IS CLASSIC SAN FRANCISCO ROW-HOUSE COUNTRY —\n" +
          "BLOCK AFTER BLOCK OF DOELGER-ERA STUCCO SINGLE-FAMILY HOMES,\n" +
          "OFTEN OVER A GROUND-FLOOR GARAGE, PLUS SOME NEWER CONDOS AND IN-LAW UNITS.\n" +
          "IT RUNS FROM A FIRST STARTER HOME TO A FULLY REMODELED BEACH-CLOSE SHOWPIECE,\n" +
          "AND HISTORICALLY YOU GET MORE SPACE FOR THE MONEY OUT HERE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR THE OUTER SUNSET ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A row of stucco Doelger homes over garages", "A 'For Sale' sign on a flat avenue block", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN THE OUTER SUNSET?\n" +
          "SOMEONE WHO WANTS THE OCEAN AT THE END OF THE BLOCK,\n" +
          "A SLOWER, MELLOWER PACE, AND DOESN'T MIND TRADING SUN FOR FOG\n" +
          "TO GET MORE SPACE AND THAT BEACH-TOWN FEEL.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST CAFE, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY OUTER SUNSET NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING THE OUTER SUNSET HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour pass down a foggy avenue toward the ocean (you, relaxed, not pitching)", "A quiet look out at Ocean Beach", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the ocean edge, the fog over the avenues, the café strip, surf culture, and row-house variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the N-Judah terminus, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Outer Sunset page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Outer Sunset + Parkside + Outer Richmond in one foggy-coast loop.",
  },
"Outer Richmond": {
    aka: "The Avenues",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Outer%20Richmond&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Outer Richmond)",
    route: {
      // Route stays ENTIRELY within the Outer Richmond boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Sutro Heights Park", note: "Start — clifftop garden above the ocean, the old Sutro estate", coord: [-122.4997, 37.7776] },
        { n: 2, name: "Lands End / Sutro Baths overlook", note: "The oceanfront ruins of the 1894 Sutro Baths + the Cliff House site", coord: [-122.5, 37.7779] },
        { n: 3, name: "Balboa St food corridor", note: "Cafes and neighborhood spots along Balboa", coord: [-122.4985, 37.7757] },
        { n: 4, name: "30th Ave & Balboa — flat avenue block", note: "The level avenue grid: classic Richmond homes, easy to get around", coord: [-122.4895, 37.7762] },
        { n: 5, name: "Clement St food corridor", note: "The Russian + Cantonese restaurant strip the avenues are known for", coord: [-122.4845, 37.7825] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M OUT BY LANDS END, AND THE FOG IS ROLLING IN OFF THE OCEAN —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE THE OUTER RICHMOND? LET'S GO.",
        broll: ["Two-shot idea: fog pouring off the ocean in one frame, a sunny avenue block in the next", "You moving along the clifftop at Lands End into frame", "The Sutro Baths ruins / Ocean Beach to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? THE OUTER RICHMOND IS THE CITY'S FAR NORTHWEST CORNER,\n" +
          "THE AVENUES RUNNING WEST TO OCEAN BEACH AND THE EDGE OF THE CONTINENT,\n" +
          "WITH GOLDEN GATE PARK TO THE SOUTH AND LANDS END ALONG THE NORTH SHORE.\n" +
          "THE SPINES ARE GEARY, BALBOA, AND CLEMENT, CROSSING THE NUMBERED AVENUES\n" +
          "OUT TO THE GREAT HIGHWAY AND THE SAND.\n" +
          "ITS OLD NICKNAME — THE AVENUES — TELLS YOU THE SHAPE OF THE LAND.\n" +
          "MOST OF THE NEIGHBORHOOD SITS LOW AND LEVEL,\n" +
          "ROUGHLY 10 TO 320 FEET UP, AND THE AVENUE GRID IS LARGELY FLAT AND EASY TO GET AROUND —\n" +
          "WELL WITHIN WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE, ABOUT FIVE PERCENT —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "WHERE IT CLIMBS IS AT THE COASTAL BLUFFS:\n" +
          "OUT AT LANDS END AND SUTRO HEIGHTS THE GROUND RISES TO THE SEA CLIFFS,\n" +
          "AND THOSE STRETCHES ARE TRAILS AND STEPS, NOT FLAT SIDEWALK.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE AVENUE GRID IS YOUR FRIEND; THE BLUFF EDGES ARE A CLIMB.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY OF THESE CLASSIC AVENUE HOMES SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan down a numbered avenue toward the ocean; Geary + Clement street signs", "Wide establishing shot showing the flat grid meeting the bluffs", "The trails climbing at Lands End / Sutro Heights (show the grade)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. AT THE TURN OF THE TWENTIETH CENTURY,\n" +
          "EVERYTHING WEST OF ARGUELLO WAS WINDSWEPT SAND DUNES AND POTATO FIELDS —\n" +
          "LUMPED WITH THE REST OF THE WESTERN CITY AS THE 'OUTSIDE LANDS.'\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "NEW CABLE AND ELECTRIC STREETCAR LINES OPENED IT UP,\n" +
          "CARRYING SAN FRANCISCANS OUT TO GOLDEN GATE PARK, OCEAN BEACH,\n" +
          "AND ADOLPH SUTRO'S CLIFF HOUSE AND SUTRO BATHS.\n" +
          "AFTER THE 1906 EARTHQUAKE AND FIRE, DISPLACED RESIDENTS\n" +
          "SETTLED THE AVENUES IN LARGE NUMBERS.\n" +
          "WAVES OF RUSSIAN REFUGEES ARRIVED AFTER THE RUSSIAN REVOLUTION,\n" +
          "AND FROM THE 1950s ONWARD — ESPECIALLY AFTER 1965 —\n" +
          "CHINESE IMMIGRANTS MADE THE DISTRICT HOME,\n" +
          "GIVING GEARY BOULEVARD AND CLEMENT STREET\n" +
          "THEIR DISTINCTIVE RUSSIAN AND CANTONESE CHARACTER.\n" +
          "TODAY THAT MIX IS THE SOUL OF THE PLACE — A GOLD-DOMED ORTHODOX CATHEDRAL\n" +
          "ON GEARY, DIM SUM AND PIROZHKI ON THE SAME BLOCK.\n" +
          "SPEND TIME ON THESE AVENUES, AND YOU'RE STANDING IN A CENTURY\n" +
          "OF SAN FRANCISCANS WHO CAME TO THE EDGE OF THE CITY AND STAYED.",
        broll: ["Numbered-avenue homes; the gold-domed Holy Virgin Cathedral on Geary", "Old Cliff House / Sutro Baths archival look-alike framing", "Clement St shopfronts — Russian + Cantonese signage side by side"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "OUT AT LANDS END SIT THE RUINS OF THE 1894 SUTRO BATHS —\n" +
          "ONCE THE WORLD'S LARGEST INDOOR SALTWATER SWIMMING COMPLEX,\n" +
          "NOW DRAMATIC OCEANFRONT STONEWORK YOU CAN STILL EXPLORE.\n" +
          "JUST ABOVE IT WAS THE CLIFF HOUSE, AND SUTRO HEIGHTS PARK —\n" +
          "THE OLD SUTRO ESTATE — STILL CROWNS THE BLUFF AS A PUBLIC GARDEN.\n" +
          "ON A RIDGE OVER LANDS END STANDS THE LEGION OF HONOR,\n" +
          "A FINE-ARTS MUSEUM MODELED ON A PARIS PALACE.\n" +
          "THE GOLD-DOMED HOLY VIRGIN CATHEDRAL ON GEARY IS THE LARGEST CATHEDRAL\n" +
          "OF THE RUSSIAN ORTHODOX CHURCH OUTSIDE RUSSIA.\n" +
          "AND TRAD'R SAM, OPENED ON GEARY IN 1937,\n" +
          "BILLS ITSELF AS THE OLDEST CONTINUOUSLY OPERATING TIKI BAR IN THE COUNTRY.\n" +
          "THIS IS A NEIGHBORHOOD THAT HIDES ITS BEST STORIES OUT AT THE EDGE.",
        broll: ["Sutro Baths ruins tight + wide", "Sutro Heights Park garden / parapet; the Legion of Honor colonnade", "Holy Virgin Cathedral domes; a vintage neon sign on Geary"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "AND I'LL BE HONEST WITH YOU UP FRONT: THE OUTER RICHMOND IS AMONG\n" +
          "THE FOGGIEST, WINDIEST, COOLEST PARTS OF THE WHOLE CITY.\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND OUT HERE IN THE AVENUES,\n" +
          "ONE LINE IS THE LIFELINE: THE 38-GEARY,\n" +
          "WITH THE 38R RAPID RUNNING THE LENGTH OF GEARY STRAIGHT DOWNTOWN.\n" +
          "BACKING IT UP ARE THE 5-FULTON ALONG THE PARK,\n" +
          "PLUS THE 18, THE 31-BALBOA, AND THE 1-CALIFORNIA TO THE NORTH.\n" +
          "THERE'S NO BART OUT HERE — THE NEAREST STATIONS ARE DOWNTOWN,\n" +
          "SO THE 38R IS HOW YOU REACH THEM.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT FIVE AND A HALF MILES NORTHEAST —\n" +
          "GENUINELY FAR FROM OUT HERE — SO PLAN ON THE 38R ACROSS TOWN\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? TAKE THE 38R DOWNTOWN AND HOP BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES ONCE YOU'RE ON THE PLATFORM.\n" +
          "HEADING NORTH TO MARIN? FROM THE FERRY BUILDING THE LARKSPUR FERRY\n" +
          "CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE TRANSIT TO THE CALTRAIN DEPOT\n" +
          "AT 4TH AND KING, AND CALTRAIN RUNS DOWN TO PALO ALTO IN ABOUT FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY FIFTY BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: THE 38-GEARY IS YOUR SPINE,\n" +
          "AND FROM DOWNTOWN THE WATER, THE RAIL, AND THE BRIDGES ALL OPEN UP —\n" +
          "EVEN OUT HERE AT THE EDGE OF THE CITY.",
        broll: [
          "A 38R-Geary bus pulling up on Geary Blvd",
          "The numbered avenues + the 5-Fulton along the park",
          "A BART train downtown; the Larkspur ferry; a Caltrain at 4th & King",
          "Simple motion-graphic map: Outer Richmond → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        words: 110,
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF — AND THIS IS THE COAST,\n" +
          "SO I WON'T SUGARCOAT IT, I'LL JUST LAY IT OUT CALMLY.\n" +
          "LIKE MUCH OF SAN FRANCISCO, PARTS OF THE NEIGHBORHOOD FALL WITHIN\n" +
          "A STATE-DESIGNATED SEISMIC HAZARD ZONE — STANDARD FOR THE CITY,\n" +
          "AND SOMETHING EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "AND BECAUSE WE'RE ON THE OCEAN, THE SHORELINE ALONG OCEAN BEACH AND LANDS END\n" +
          "SITS IN A MAPPED TSUNAMI EVACUATION ZONE.\n" +
          "THE GOOD NEWS: THE BLUFF HOMES SIT HIGHER AND ABOVE IT —\n" +
          "IT'S THE LOW SHORELINE THAT'S THE EVACUATION ZONE.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing from the bluff down to the shoreline", "Ocean Beach / the Great Highway", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "THE OUTER RICHMOND'S FOOD SCENE IS ONE OF THE CITY'S BEST-KEPT SECRETS —\n" +
          "CLEMENT STREET AND BALBOA STREET ARE LINED WITH DIM SUM, RUSSIAN BAKERIES,\n" +
          "FAMILY-RUN CAFES, AND SOME GENUINELY HISTORIC NEIGHBORHOOD BARS.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY OUTER RICHMOND DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A QUIET, RESIDENTIAL, COOK-AT-HOME-AND-EXPLORE-THE-COAST\n" +
          "KIND OF PLACE, WITH GREAT FOOD A FEW BLOCKS IN EVERY DIRECTION.",
        broll: ["Clement St shopfronts at dusk; a busy dim sum window", "Balboa St cafes; people on the sidewalk", "A classic neighborhood bar sign (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: THE OUTER RICHMOND IS CLASSIC SAN FRANCISCO AVENUES —\n" +
          "ROWS OF MARINA-STYLE AND EDWARDIAN HOMES ON THE NUMBERED STREETS,\n" +
          "SINGLE-FAMILY HOUSES WITH GARAGES TUCKED UNDERNEATH,\n" +
          "AND FLATS AND CONDOS NEARER THE COMMERCIAL CORRIDORS.\n" +
          "IT RUNS FROM A FIRST CONDO TO A FULLY RESTORED OCEANFRONT-ADJACENT HOME.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR THE OUTER RICHMOND ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A row of numbered-avenue homes; a flats building; a condo entry", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN THE OUTER RICHMOND?\n" +
          "SOMEONE WHO WANTS THE OCEAN AT THE END OF THE BLOCK,\n" +
          "A QUIET RESIDENTIAL CALM, AND A COOL, FOGGY EDGE-OF-THE-CITY PEACE.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY OUTER RICHMOND NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING THE OUTER RICHMOND HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour pass along a numbered avenue toward the ocean (you, relaxed, not pitching)", "A quiet look out over Lands End and the water", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the Lands End ruins, Sutro Heights, Clement + Balboa street life, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the bus stops on Geary, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Outer Richmond page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Outer Richmond + Inner Richmond + Seacliff in one morning loop.",
  },
"Dogpatch": {
    aka: "Central Waterfront",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Dogpatch&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Dogpatch)",
    route: {
      // Route stays ENTIRELY within the Dogpatch boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Third & 20th — T-Third platform", note: "Start — the light-rail spine and the Muni Metro stop", coord: [-122.3895, 37.7607] },
        { n: 2, name: "Minnesota & 20th — workers' cottages", note: "The intact 1870s–1910 cottage blocks", coord: [-122.3905, 37.7603] },
        { n: 3, name: "Tennessee St cottages", note: "More of the Eastlake-style cottage rows", coord: [-122.3884, 37.7600] },
        { n: 4, name: "Museum of Craft and Design", note: "569 Third St — the arts-and-makers anchor", coord: [-122.3898, 37.7595] },
        { n: 5, name: "Pier 70 / the old shipyards", note: "The historic industrial-maritime waterfront", coord: [-122.3878, 37.7613] },
        { n: 6, name: "22nd & Third — brewery/maker block", note: "End — the breweries and maker spaces near 22nd", coord: [-122.3889, 37.7580] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON THIRD STREET IN DOGPATCH, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE DOGPATCH? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Third St in the next", "You moving up Third St into frame", "A T-Third train / the bay edge to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? DOGPATCH SITS ON THE EASTERN BAYFRONT OF SAN FRANCISCO,\n" +
          "JUST BELOW POTRERO HILL AND SOUTH OF MISSION BAY,\n" +
          "WITH THE WATER AND PIER 70 RIGHT OFF ITS EASTERN EDGE.\n" +
          "THE MAIN SPINE IS THIRD STREET, RUNNING THROUGH THE HEART OF IT,\n" +
          "WITH THE OLD COTTAGE BLOCKS ON MINNESOTA AND TENNESSEE JUST OFF IT.\n" +
          "ITS OTHER NAME — CENTRAL WATERFRONT — TELLS YOU THE SHAPE OF THE LAND.\n" +
          "THIS IS FORMER-INDUSTRIAL FLATLAND, ROUGHLY 10 TO 80 FEET UP,\n" +
          "AND THE CORE IS FLAT, LEVEL, AND EASY TO GET AROUND —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "THE GRADE STAYS WELL WITHIN WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE —\n" +
          "ABOUT FIVE PERCENT — SO GETTING AROUND ON THE LEVEL IS RARELY THE PROBLEM HERE.\n" +
          "BUT THE HOMES THEMSELVES MATTER TOO —\n" +
          "DOGPATCH IS A MIX OF OLD WORKERS' COTTAGES, CONVERTED LOFTS, AND NEW CONDOS,\n" +
          "AND THE ENTRIES VARY: A COTTAGE MIGHT SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "WHILE A NEW BUILDING MAY HAVE STEP-FREE, ELEVATORED ACCESS.\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan up Third St; street signs at 20th & Third", "Wide establishing shot showing the flat blocks + the bay edge", "A row of workers' cottages on Minnesota St"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. DOGPATCH GREW UP IN THE 1870s AS AN INFORMAL COMPANY TOWN —\n" +
          "WORKERS' HOUSING FOR THE IRONWORKS, REFINERIES, AND SHIPYARDS\n" +
          "ALONG THIS EDGE OF THE BAY.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "DEVELOPERS THREW UP ROWS OF CHEAP VICTORIAN AND EDWARDIAN COTTAGES\n" +
          "FOR FAMILIES WHO WORKED THE WATERFRONT.\n" +
          "AND HERE'S THE THING THAT MAKES DOGPATCH RARE:\n" +
          "IT SURVIVED THE 1906 EARTHQUAKE AND FIRE.\n" +
          "WHILE SO MUCH OF THE CITY BURNED, THESE BLOCKS WERE SPARED —\n" +
          "LEAVING ONE OF SAN FRANCISCO'S OLDEST, MOST INTACT DISTRICTS\n" +
          "OF WORKERS' COTTAGES AND INDUSTRIAL-MARITIME BLOCKS,\n" +
          "INCLUDING THE OLD SHIPYARDS AT PIER 70.\n" +
          "SHIPBUILDING FADED AFTER WORLD WAR TWO,\n" +
          "AND IN RECENT DECADES THE OLD INDUSTRIAL BLOCKS HAVE BEEN REBORN —\n" +
          "AN ARTS-AND-MAKERS DISTRICT NOW, WITH BREWERIES, GALLERIES,\n" +
          "AND THE AMERICAN INDUSTRIAL CENTER FULL OF SMALL WORKSHOPS.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING IN LIVING WORKING-CLASS HISTORY.",
        broll: ["Cottage facades on Tennessee St", "Pier 70 / the old shipyard structures", "The American Industrial Center building"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "DOGPATCH IS A RARE SURVIVOR OF THE 1906 FIRE —\n" +
          "ONE OF THE CITY'S OLDEST CLUSTERS OF WORKERS' COTTAGES STILL STANDING.\n" +
          "THE OLD SHIPYARDS AT PIER 70 BUILT WARSHIPS RIGHT ON THIS WATERFRONT,\n" +
          "AND THE INDUSTRIAL BONES OF THE PLACE ARE STILL ALL AROUND YOU.\n" +
          "THAT BIG BRICK COMPLEX IS THE AMERICAN INDUSTRIAL CENTER,\n" +
          "NOW PACKED WITH SMALL MAKERS, STUDIOS, AND WORKSHOPS.\n" +
          "THERE'S THE MUSEUM OF CRAFT AND DESIGN RIGHT ON THIRD STREET,\n" +
          "AND BREWERIES TUCKED INTO THE OLD WAREHOUSE BLOCKS.\n" +
          "AND THE T-THIRD LIGHT-RAIL LINE THREADS THE WHOLE NEIGHBORHOOD TOGETHER.\n" +
          "THIS IS A NEIGHBORHOOD THAT WEARS ITS WORKING HISTORY OUT LOUD.",
        broll: ["A cottage row tight shot", "Pier 70 shipyard / crane", "The Museum of Craft and Design entrance"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "DOGPATCH SITS IN ONE OF THE CITY'S SUNNIEST, WARMEST POCKETS.\n" +
          "WHILE THE AVENUES OUT WEST DISAPPEAR INTO SUMMER FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND DOGPATCH IS ONE OF THE EASIEST PLACES\n" +
          "IN THE WHOLE CITY TO LIVE WITHOUT A CAR.\n" +
          "RIGHT ON THIRD STREET IS THE T-THIRD MUNI METRO,\n" +
          "THE LIGHT-RAIL LINE THAT RUNS STRAIGHT UP TOWARD DOWNTOWN AND THE EMBARCADERO.\n" +
          "THE 22 AND THE 48 BUSES THREAD THROUGH THE NEIGHBORHOOD TOO,\n" +
          "AND CALTRAIN'S 22ND STREET STATION IS RIGHT NEARBY.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT TWO AND A HALF MILES NORTH,\n" +
          "A QUICK RIDE UP THE T-THIRD TO THE EMBARCADERO,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? FROM DOWNTOWN, HOP BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES DOOR TO PLATFORM.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? THIS IS THE EASY ONE —\n" +
          "DOGPATCH IS CLOSE TO CALTRAIN. TAKE THE TRAIN FROM 22ND STREET,\n" +
          "OR FROM THE 4TH AND KING DEPOT, AND CALTRAIN RUNS DOWN TO PALO ALTO\n" +
          "IN ABOUT FIFTY MINUTES — OR IT'S A STRAIGHT SHOT BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: WATER, RAIL, AND THE BRIDGES — ALL WITHOUT OWNING A CAR.",
        broll: [
          "A T-Third train on Third St; the 22nd St Caltrain platform",
          "Embarcadero / the Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; a Caltrain at 22nd St",
          "Simple motion-graphic map: Dogpatch → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "DOGPATCH IS LOW, FORMER-INDUSTRIAL BAYFRONT, AND PARTS OF IT SIT ON FILL,\n" +
          "SO I'M GOING TO BE STRAIGHT WITH YOU ABOUT IT.\n" +
          "MUCH OF THE NEIGHBORHOOD FALLS WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE\n" +
          "FOR LIQUEFACTION — THAT'S COMMON FOR THE CITY'S LOW, FILLED BAYFRONT,\n" +
          "AND IT'S SOMETHING EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "AND BECAUSE IT'S RIGHT ON THE WATER, PARTS OF DOGPATCH ALSO LIE\n" +
          "WITHIN A MAPPED TSUNAMI HAZARD ZONE — WORTH KNOWING CALMLY, NOT FEARFULLY.\n" +
          "THE SMART MOVE IS SIMPLY TO REVIEW THE SOILS, ANY RETROFITS, AND THE INSURANCE.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the flat blocks / the bay edge", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "DOGPATCH PUNCHES WAY ABOVE ITS SIZE ON FOOD AND DRINK —\n" +
          "COFFEE, BAKERIES, BREWERIES IN THE OLD WAREHOUSES,\n" +
          "AND SOME OF THE CITY'S MOST BELOVED RESTAURANTS ALONG THIRD STREET.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY DOGPATCH DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A RIGHT-OUTSIDE-YOUR-DOOR, LEAVE-THE-CAR-HOME KIND OF PLACE.",
        broll: ["Café tables; a busy restaurant window at dusk", "A brewery taproom in an old warehouse", "A maker storefront / gallery window (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: DOGPATCH IS A TRUE MIX —\n" +
          "ORIGINAL VICTORIAN AND EDWARDIAN WORKERS' COTTAGES,\n" +
          "CONVERTED INDUSTRIAL LOFTS, AND NEW CONDO BUILDINGS NEARER THE WATER.\n" +
          "IT RUNS FROM A FIRST LOFT OR CONDO TO A LOVINGLY RESTORED COTTAGE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR DOGPATCH ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A workers' cottage, a loft conversion, a modern condo entry", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN DOGPATCH?\n" +
          "SOMEONE WHO WANTS SUN, EASE, A REAL MAKER-AND-ARTS COMMUNITY,\n" +
          "AND THE WHOLE BAY AREA A TRAIN OR A FERRY AWAY, WITHOUT EVER NEEDING A CAR.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY DOGPATCH NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING DOGPATCH HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass down Third St (you, relaxed, not pitching)", "A quiet look toward Pier 70 and the water", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the cottage rows, Pier 70, Third St life, brewery/maker blocks, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the T-Third platform, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Dogpatch page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Dogpatch + Potrero Hill + Mission Bay in one morning loop.",
  },
"Mission Bay": {
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Mission%20Bay&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Mission Bay)",
    route: {
      // Route stays ENTIRELY within the Mission Bay boundary (verified against the
      // neighborhood polygon). Coords approximate — snap to the sidewalk grid for the final cut.
      spots: [
        { n: 1, name: "Mission Creek waterfront & houseboats", note: "Start — the creek-side promenade and the floating-home community", coord: [-122.3920, 37.7705] },
        { n: 2, name: "UCSF Mission Bay campus green", note: "The research-campus quad and Genentech Hall", coord: [-122.3905, 37.7680] },
        { n: 3, name: "Chase Center plaza (Thrive City)", note: "The Warriors arena and its public plaza", coord: [-122.3878, 37.7680] },
        { n: 4, name: "Fourth Street condo cluster", note: "New mid-rise condos and apartments along the spine", coord: [-122.3915, 37.7730] },
        { n: 5, name: "Caltrain at 4th & King", note: "The rail terminus right at the northern edge", coord: [-122.3947, 37.7765] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M BY THE CREEK AT MISSION BAY, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE MISSION BAY? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Mission Creek in the next", "You moving along the creek-side promenade into frame", "The houseboats / Chase Center skyline to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? MISSION BAY SITS ON THE EASTERN BAYFRONT OF SAN FRANCISCO,\n" +
          "JUST SOUTH OF SOUTH BEACH AND THE BALLPARK, EAST OF SHOWPLACE SQUARE,\n" +
          "WITH DOGPATCH BELOW AND THE BAY ITSELF RIGHT OUT THE FRONT DOOR.\n" +
          "THE SPINE IS THIRD STREET, RUNNING PAST UCSF AND THE CHASE CENTER,\n" +
          "WITH MISSION CREEK THREADING ALONG THE NORTHERN EDGE.\n" +
          "THIS IS ABOUT AS FLAT AS SAN FRANCISCO GETS — THE LAND BARELY RISES\n" +
          "FROM ZERO TO ABOUT THIRTY FEET ACROSS THE WHOLE NEIGHBORHOOD.\n" +
          "AND BECAUSE IT'S BRAND-NEW AND BUILT FLAT BY DESIGN,\n" +
          "IT'S ONE OF THE MOST ACCESSIBLE PLACES IN THE WHOLE CITY —\n" +
          "FULLY LEVEL AND STEP-FREE, WITH ELEVATORS STANDARD IN THESE BUILDINGS,\n" +
          "AND GRADES THAT STAY WELL WITHIN WHAT THE A-D-A CONSIDERS\n" +
          "AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR —\n" +
          "THERE'S NO HILL TO FIGHT HERE, AND NO FLIGHT OF STAIRS\n" +
          "UP TO THE FRONT DOOR THE WAY THERE IS IN THE OLDER NEIGHBORHOODS.\n" +
          "IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU, THIS MAY BE THE EASIEST\n" +
          "NEIGHBORHOOD IN SAN FRANCISCO TO GET AROUND.",
        broll: ["Slow pan up Third St; street signs at 4th & Mission Bay Blvd", "Wide establishing shot showing the flat bayfront + Chase Center", "A level, step-free building entry with an elevator lobby"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. MISSION BAY IS THE CITY'S NEWEST NEIGHBORHOOD —\n" +
          "BUILT FROM THE GROUND UP STARTING IN THE 2000s\n" +
          "ON FORMER RAIL YARDS AND BAY FILL ALONG MISSION CREEK.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "FOR OVER A CENTURY THIS WAS WHARVES AND SOUTHERN PACIFIC RAILROAD YARDS,\n" +
          "AND WHEN THE TRAINS LEFT, THE LAND SAT LARGELY VACANT FOR DECADES.\n" +
          "THEN CAME THE TURN. A ROUGHLY 300-ACRE REDEVELOPMENT —\n" +
          "THE CITY'S LARGEST SINCE GOLDEN GATE PARK — BROKE GROUND,\n" +
          "AND UCSF OPENED ITS MISSION BAY RESEARCH CAMPUS IN 2003,\n" +
          "ANCHORING ONE OF THE NATION'S LARGEST BIOMEDICAL UNIVERSITY EXPANSIONS\n" +
          "AND SEEDING A WHOLE CLUSTER OF BIOTECH COMPANIES.\n" +
          "THE WARRIORS' CHASE CENTER ARENA FOLLOWED IN 2019,\n" +
          "AND NEW WATERFRONT PARKS HAVE KEPT OPENING INTO THE 2020s.\n" +
          "SO WHEN YOU STAND HERE, YOU'RE STANDING ON A NEIGHBORHOOD\n" +
          "THAT BARELY EXISTED A GENERATION AGO —\n" +
          "A WHOLE DISTRICT WILLED INTO BEING WHERE FREIGHT CARS ONCE PARKED.",
        broll: ["Archival idea: old rail-yard / wharf photos", "UCSF Genentech Hall and the campus green", "Chase Center exterior; a new waterfront park"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "TUCKED ALONG MISSION CREEK IS A LITTLE FLOATING-HOME COMMUNITY —\n" +
          "HOUSEBOATS THAT HAVE BOBBED HERE SINCE LONG BEFORE THE TOWERS WENT UP,\n" +
          "A QUIET SURVIVOR FROM THE OLD WATERFRONT.\n" +
          "THE UCSF MISSION BAY CAMPUS HELPED GROW THE CITY'S BIOTECH SECTOR\n" +
          "FROM ONE COMPANY TO MORE THAN A HUNDRED WITHIN A DECADE.\n" +
          "THE CHASE CENTER, HOME OF THE GOLDEN STATE WARRIORS,\n" +
          "WAS PRIVATELY FINANCED AND SEATS ABOUT EIGHTEEN THOUSAND\n" +
          "FOR BASKETBALL AND CONCERTS ALIKE.\n" +
          "AND ORACLE PARK — WHERE THE GIANTS PLAY — IS RIGHT NEXT DOOR,\n" +
          "SO ON A GOOD WEEK YOU CAN CATCH A BALL GAME AND A SHOW\n" +
          "WITHOUT EVER LEAVING THE NEIGHBORHOOD.\n" +
          "THIS IS A PLACE WHERE BRAND-NEW AND OLD-WATERFRONT SIT SIDE BY SIDE.",
        broll: ["The houseboats on Mission Creek", "UCSF lab / campus signage", "Chase Center bowl; Oracle Park nearby"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "MISSION BAY SITS ON THE EASTERN BAYFRONT, ON THE CITY'S SUNNY SIDE.\n" +
          "WHILE THE AVENUES OUT WEST DISAPPEAR INTO SUMMER FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND MISSION BAY IS ONE OF THE EASIEST PLACES\n" +
          "IN THE WHOLE CITY TO LIVE WITHOUT A CAR.\n" +
          "RUNNING RIGHT UP THIRD STREET IS THE T-THIRD MUNI METRO LINE,\n" +
          "WITH A STOP AT UCSF AND THE CHASE CENTER.\n" +
          "CALTRAIN'S TERMINUS IS AT 4TH AND KING, RIGHT AT THE EDGE,\n" +
          "AND PLENTY OF MUNI BUSES THREAD THROUGH, PLUS DEDICATED\n" +
          "CHASE CENTER EVENT SERVICE ON GAME AND CONCERT NIGHTS.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT A MILE AND A HALF NORTH,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? TAKE MUNI DOWNTOWN AND HOP BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES DOOR TO PLATFORM.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          ...
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? HERE'S THE STANDOUT:\n" +
          "CALTRAIN IS RIGHT HERE AT 4TH AND KING — NO TRANSFER NEEDED —\n" +
          "AND IT RUNS DOWN TO PALO ALTO IN ABOUT FIFTY MINUTES,\n" +
          "OR IT'S ROUGHLY FORTY-FIVE BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: WATER, RAIL, AND THE PENINSULA TRAIN AT YOUR DOORSTEP —\n" +
          "ALL WITHOUT OWNING A CAR.",
        broll: [
          "A T-Third train on Third St; the UCSF/Chase Center stop",
          "Caltrain at 4th & King; the Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; Chase Center event-night crowds",
          "Simple motion-graphic map: Mission Bay → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "I'LL BE STRAIGHT WITH YOU: THIS WHOLE NEIGHBORHOOD SITS ON BAY FILL\n" +
          "AND FORMER RAIL YARDS, RIGHT AT THE WATER'S EDGE.\n" +
          "THAT MEANS IT FALLS WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE\n" +
          "FOR LIQUEFACTION, AND ALSO WITHIN A MAPPED TSUNAMI HAZARD ZONE.\n" +
          "NOW — THE BUILDINGS HERE ARE BRAND-NEW AND ENGINEERED TO CURRENT CODE,\n" +
          "DESIGNED FOR EXACTLY THIS GROUND, WHICH IS A REAL ADVANTAGE.\n" +
          "BUT IT'S STILL SOMETHING EVERY CALIFORNIA BUYER REVIEWS\n" +
          "WITH THEIR INSPECTOR AND INSURER.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the bayfront / the fill ground", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "MISSION BAY'S DINING CLUSTERS AROUND THE CHASE CENTER PLAZA\n" +
          "AND ALONG THE WATERFRONT — CASUAL SPOTS, COFFEE, AND GAME-DAY ENERGY,\n" +
          "WITH MORE ARRIVING AS THE NEIGHBORHOOD KEEPS FILLING IN.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY MISSION BAY DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A NEW, OPEN, BY-THE-WATER KIND OF PLACE —\n" +
          "EASY TO GET AROUND AND BUILT FOR LIFE WITHOUT A CAR.",
        broll: ["Plaza café tables; a busy restaurant window at dusk", "Chase Center lit up; people on the plaza", "The waterfront promenade at golden hour"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: MISSION BAY IS THE OPPOSITE OF OLD SAN FRANCISCO —\n" +
          "IT'S MOSTLY NEW MID-RISE AND HIGH-RISE CONDOS AND APARTMENTS,\n" +
          "BUILT IN THE LAST TWENTY YEARS, WITH ELEVATORS, GARAGES,\n" +
          "AND STEP-FREE ACCESS AS THE NORM RATHER THAN THE EXCEPTION.\n" +
          "IT RUNS FROM A FIRST CONDO TO A LIGHT-FILLED BAYFRONT UNIT WITH A VIEW.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR MISSION BAY ON MY SITE —\n" +
          "CURRENT MEDIANS FOR CONDOS AND APARTMENTS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A modern mid-rise condo entry; a high-rise lobby", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN MISSION BAY?\n" +
          "SOMEONE WHO WANTS NEW, LEVEL, LIGHT-FILLED LIVING BY THE WATER,\n" +
          "WITH A TRAIN AT THE DOORSTEP AND THE WHOLE BAY AREA WITHIN REACH,\n" +
          ...
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY MISSION BAY NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING MISSION BAY HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass along the creek (you, relaxed, not pitching)", "A quiet look out across the bay", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the creek, houseboats, UCSF campus, Chase Center, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      ...
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Mission Bay page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Mission Bay + South Beach + Dogpatch in one bayfront loop.",
  },
"South Beach": {
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=South%20Beach&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → South Beach)",
    route: {
      // Route stays ENTIRELY within the South Beach boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Oracle Park & McCovey Cove waterfront", note: "Start — the ballpark (2000, the Giants) + the kayakers in the cove", coord: [-122.3892, 37.7785] },
        { n: 2, name: "South Beach Harbor marina", note: "The yacht-filled marina between Pier 40 and the ballpark", coord: [-122.3886, 37.7805] },
        { n: 3, name: "Embarcadero promenade — Bay Bridge views", note: "The bayfront paths with the Bay Bridge lights overhead", coord: [-122.3878, 37.7843] },
        { n: 4, name: "Brannan & Townsend lofts", note: "The housing-stock segment: brick-and-timber lofts and condos", coord: [-122.3915, 37.7822] },
        { n: 5, name: "2nd & King — Muni & Caltrain edge", note: "The transit corner: N-Judah at the door, Caltrain a few blocks", coord: [-122.3905, 37.7795] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON THE EMBARCADERO BY ORACLE PARK, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE SOUTH BEACH? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny South Beach waterfront in the next", "You moving along the Embarcadero into frame", "The ballpark / Bay Bridge to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? SOUTH BEACH SITS ON SAN FRANCISCO'S\n" +
          "SOUTHEAST BAYFRONT, JUST DOWNTOWN OF THE FINANCIAL DISTRICT,\n" +
          "WITH SOMA BEHIND IT, RINCON HILL TO THE NORTH,\n" +
          "AND MISSION BAY OVER THE CHANNEL TO THE SOUTH.\n" +
          "THE WATERFRONT SPINE IS THE EMBARCADERO, WRAPPING AROUND ORACLE PARK\n" +
          "AND THE SOUTH BEACH HARBOR MARINA RIGHT ON THE BAY.\n" +
          "THIS IS RECLAIMED WATERFRONT, SO THE LAND IS DEAD FLAT —\n" +
          "ROUGHLY ZERO TO SIXTY FEET UP, A LEVEL WATERFRONT THAT IS EASY TO GET AROUND.\n" +
          "THE GRADE STAYS WELL WITHIN WHAT THE A-D-A CONSIDERS ACCESSIBLE — ABOUT FIVE PERCENT —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "AND THE HOMES HELP HERE TOO: THIS IS MOSTLY CONDOS AND LOFTS\n" +
          "WITH ELEVATORS, WHICH MAKES SOUTH BEACH ONE OF THE MORE STEP-FREE\n" +
          "AREAS IN THE WHOLE CITY.\n" +
          "SO IF LOW-GRADE, STEP-FREE ACCESS MATTERS TO YOU,\n" +
          "THIS IS ABOUT AS EASY AS SAN FRANCISCO GETS —\n" +
          "THOUGH IT'S STILL WORTH CHECKING ENTRY AND ELEVATOR ACCESS HOME BY HOME.",
        broll: ["Slow pan along the Embarcadero; the ballpark in the background", "Wide establishing shot showing the flat waterfront + the Bay", "The marina docks and the loft blocks behind them"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. SOUTH BEACH SPENT MORE THAN A CENTURY\n" +
          "AS A WORKING WATERFRONT — INDUSTRIAL PIERS, RAIL YARDS,\n" +
          "AND WAREHOUSES ALONG CHINA BASIN.\n" +
          "ALL OF THIS BAYFRONT WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE\n" +
          "LONG BEFORE THE PIERS AND THE FILL.\n" +
          "THE TURN CAME IN THE 1980s. THE SOUTH BEACH HARBOR MARINA\n" +
          "OPENED IN 1986 ON PORT OF SAN FRANCISCO LAND,\n" +
          "AND THE NEIGHBORHOOD BEGAN ITS REBIRTH.\n" +
          "THEN THE GIANTS BROKE GROUND FOR A NEW BALLPARK AT THIRD AND KING,\n" +
          "AND ON APRIL 11TH, 2000, ORACLE PARK OPENED ON THE WATER —\n" +
          "TURNING A SLEEPY INDUSTRIAL DISTRICT INTO A DENSE WATERFRONT VILLAGE\n" +
          "OF CONDOS, RESTAURANTS, AND GAME-DAY CROWDS.\n" +
          "THE EMBARCADERO PROMENADE OPENED THE BAYFRONT BACK UP TO PEOPLE,\n" +
          "AND THE OLD BRANNAN AND TOWNSEND WAREHOUSES BECAME\n" +
          "BRICK-AND-TIMBER LOFTS.\n" +
          "TODAY IT BLENDS MARINA LIVING, WATERFRONT PARKS, AND BALLPARK ENERGY.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING ON A WATERFRONT REBORN.",
        broll: ["Oracle Park exterior at Third & King", "The marina and its concrete docks", "Brick loft facades on Brannan / Townsend"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "ORACLE PARK WAS THE FIRST PRIVATELY FINANCED MAJOR LEAGUE BALLPARK\n" +
          "SINCE DODGER STADIUM IN 1962 — IT OPENED AS PACIFIC BELL PARK IN 2000.\n" +
          "THE SLICE OF BAY BEYOND THE RIGHT-FIELD WALL IS NICKNAMED McCOVEY COVE,\n" +
          "WHERE KAYAKERS WAIT TO FISH OUT HOME-RUN 'SPLASH HITS.'\n" +
          "THE SOUTH BEACH HARBOR HOLDS ABOUT 700 SLIPS,\n" +
          "JUST HALF A MILE SOUTH OF THE BAY BRIDGE.\n" +
          "AND UP THE EMBARCADERO AT RINCON PARK, THERE'S CUPID'S SPAN —\n" +
          "A SIXTY-FOOT BOW-AND-ARROW SCULPTURE INSTALLED IN 2002,\n" +
          "FRAMING THE WATERFRONT'S BAY BRIDGE VIEWS.\n" +
          "AND THOSE BAY BRIDGE LIGHTS YOU SEE AT NIGHT ARE PART OF THE VIEW HERE.\n" +
          "THIS IS A NEIGHBORHOOD THAT WEARS ITS WATERFRONT OUT LOUD.",
        broll: ["Kayakers in McCovey Cove", "The marina full of masts", "Cupid's Span with the Bay Bridge behind"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "SOUTH BEACH SITS IN ONE OF THE CITY'S SUNNIER POCKETS.\n" +
          "WHILE THE AVENUES OUT WEST DISAPPEAR INTO SUMMER FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND SOUTH BEACH IS ONE OF THE EASIEST PLACES\n" +
          "IN THE WHOLE CITY TO LIVE WITHOUT A CAR.\n" +
          "RIGHT BESIDE THE BALLPARK IS THE N-JUDAH AND THE T-THIRD MUNI METRO,\n" +
          "RUNNING STRAIGHT DOWNTOWN AND THROUGH THE CENTRAL SUBWAY.\n" +
          "ALONG THE WATER, THE HISTORIC F-LINE STREETCAR HEADS TO THE FERRY BUILDING,\n" +
          "MANY BUSES THREAD THROUGH, AND CALTRAIN TERMINATES\n" +
          "AT 4TH AND KING JUST A FEW BLOCKS AWAY.\n" +
          "AND THE FERRY BUILDING ITSELF IS ABOUT A MILE UP THE EMBARCADERO.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS CLOSE — ABOUT A MILE NORTH ALONG THE WATER,\n" +
          "AND THAT'S YOUR GATEWAY TO THE BAY.\n" +
          "GOING TO THE EAST BAY? TAKE MUNI A FEW STOPS TO EMBARCADERO, HOP BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT FIFTEEN TO TWENTY MINUTES.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          ...
          "DOWN TO PALO ALTO IN ABOUT FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: WATER, RAIL, FERRIES, AND THE BRIDGES — ALL WITHOUT OWNING A CAR.",
        broll: [
          "The N-Judah / T-Third platform by the ballpark; an F-line streetcar on the Embarcadero",
          "The Ferry Building / a departing ferry",
          "A BART train; the Bay Bridge; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: South Beach → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "SOUTH BEACH IS BUILT ON BAYFRONT FILL, RIGHT DOWN AT THE WATER,\n" +
          "AND I'LL BE STRAIGHT WITH YOU ABOUT WHAT THAT MEANS.\n" +
          "PARTS OF THE NEIGHBORHOOD FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE\n" +
          "FOR LIQUEFACTION — THAT'S WHAT FILLED WATERFRONT LAND CAN DO IN A QUAKE,\n" +
          "AND IT'S SOMETHING EVERY BUYER HERE REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "AND BECAUSE IT'S RIGHT ON THE BAY, IT ALSO SITS IN A TSUNAMI HAZARD ZONE.\n" +
          "NONE OF THAT IS A DEAL-BREAKER — IT'S JUST HOMEWORK.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the waterfront / the fill line", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "SOUTH BEACH HAS A LIVELY WATERFRONT FOOD-AND-DRINK SCENE —\n" +
          "COFFEE, BRUNCH, CLASSIC DINNER SPOTS, AND GAME-DAY BARS\n" +
          "THAT FILL UP WHENEVER THE GIANTS ARE HOME.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY SOUTH BEACH DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A RIGHT-OUTSIDE-YOUR-DOOR, LEAVE-THE-CAR-HOME KIND OF PLACE.",
        broll: ["Café tables along the Embarcadero; a busy restaurant window at dusk", "A game-day crowd spilling toward the ballpark", "A classic waterfront bar sign (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: SOUTH BEACH IS MOSTLY CONDOS AND LOFTS —\n" +
          "BRICK-AND-TIMBER CONVERSIONS ON BRANNAN AND TOWNSEND,\n" +
          "AND MODERN WATERFRONT CONDO BUILDINGS NEAR THE MARINA AND THE BALLPARK.\n" +
          "IT RUNS FROM A FIRST CONDO TO A FULL-FLOOR BAY-VIEW SHOWPIECE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR SOUTH BEACH ON MY SITE —\n" +
          "CURRENT MEDIANS FOR CONDOS AND LOFTS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A brick loft conversion, a modern condo entry, a marina-view balcony", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN SOUTH BEACH?\n" +
          "SOMEONE WHO WANTS LIGHT, EASE, THE WATER AT THE DOOR, AND THE WHOLE BAY AREA\n" +
          "A TRAIN OR A FERRY AWAY, WITHOUT EVER NEEDING A CAR.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY SOUTH BEACH NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING SOUTH BEACH HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass along the Embarcadero (you, relaxed, not pitching)", "A quiet look out over the marina toward the Bay Bridge", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the ballpark, the marina, the Embarcadero, Bay Bridge views, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the marina docks, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the South Beach page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. South Beach + Rincon Hill + Mission Bay in one waterfront loop.",
  },
"Rincon Hill": {
    aka: "The East Cut",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Rincon%20Hill&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Rincon Hill)",
    route: {
      // Route stays ENTIRELY within the Rincon Hill boundary (verified against
      // the neighborhood polygon). Coords approximate — I'll snap to the
      // sidewalk grid for the final cut.
      spots: [
        { n: 1, name: "Bay Bridge anchorage / Bridgeview", note: "Start — under the western anchorage of the Bay Bridge, the bay opening up", coord: [-122.3901, 37.7866] },
        { n: 2, name: "One Rincon Hill towers", note: "The residential tower cluster — the tallest residential towers in the city", coord: [-122.3905, 37.7867] },
        { n: 3, name: "Salesforce Transit Center & rooftop park", note: "The regional transit hub + the elevated park on top", coord: [-122.3926, 37.788] },
        { n: 4, name: "Folsom Street tower corridor", note: "The dense new condo spine through the neighborhood's core", coord: [-122.3920, 37.7882] },
        { n: 5, name: "The Embarcadero edge", note: "The bayfront promenade — water, the F-line, the Ferry Building beyond", coord: [-122.3868, 37.7890] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M AT THE FOOT OF THE BAY BRIDGE ON RINCON HILL, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE RINCON HILL? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Rincon Hill towers in the next", "You moving toward the Bay Bridge anchorage into frame", "The glass towers / the bridge to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? RINCON HILL SITS ON SAN FRANCISCO'S DOWNTOWN BAYFRONT,\n" +
          "RIGHT AT THE FOOT OF THE BAY BRIDGE, JUST SOUTH OF THE FINANCIAL DISTRICT\n" +
          "AND EAST OF SOMA, WITH THE EMBARCADERO AND THE WATER ON ITS EDGE.\n" +
          "THIS IS THE CITY'S HIGH-RISE RESIDENTIAL TOWER DISTRICT —\n" +
          "A VERTICAL NEIGHBORHOOD OF GLASS TOWERS, INCLUDING THE TALLEST RESIDENTIAL\n" +
          "TOWERS IN SAN FRANCISCO, ALL CLUSTERED AT THE BRIDGE'S WESTERN ANCHORAGE.\n" +
          "THE LAND ITSELF IS LOW — ROUGHLY SEA LEVEL UP TO ABOUT 110 FEET —\n" +
          "WITH A MODEST RISE UP TOWARD THE BRIDGE ANCHORAGE.\n" +
          "NOW, HOW ACCESSIBLE IS IT? THE TOWER DISTRICT IS SERVED BY ELEVATORS,\n" +
          "SO ONCE YOU'RE INSIDE, IT'S STEP-FREE — FRIENDLY WHETHER YOU'RE\n" +
          "PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "OUTSIDE, THE STREETS DO HAVE SOME GRADE AS YOU MOVE TOWARD THE BRIDGE,\n" +
          "AND A FEW CROSSINGS NEAR THE ON-RAMPS ARE WORTH NOTING —\n" +
          "BIG, BUSY INTERSECTIONS, SO PLAN YOUR ROUTE AT STREET LEVEL.\n" +
          "BUT FOR A DOWNTOWN NEIGHBORHOOD, THE CORE IS GENUINELY EASY TO GET AROUND,\n" +
          "AND THE BUILDINGS THEMSELVES ARE MODERN AND STEP-FREE INSIDE.",
        broll: ["Slow pan up toward the bridge anchorage; the tower cluster", "Wide establishing shot showing the towers + the bay", "A street-level crossing near the bridge on-ramps (show the scale)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          ...
          "LONG BEFORE THE CITY GREW UP AROUND IT.\n" +
          "IN THE 1850s AND 60s, RINCON HILL WAS SAN FRANCISCO'S FIRST FASHIONABLE ADDRESS —\n" +
          "A GRAND 19TH-CENTURY MANSION HILL, A PRE-NOB HILL ENCLAVE OF GARDEN ESTATES\n" +
          "WHERE THE CITY'S WEALTHIEST FAMILIES BUILT THEIR HOMES.\n" +
          "THEN CAME THE CHANGE. IN 1869 THE CONTROVERSIAL SECOND STREET CUT\n" +
          "CARVED A DEEP CHASM THROUGH THE HILL TO REACH THE WATERFRONT WHARVES,\n" +
          "AND THE NEIGHBORHOOD LOST ITS CACHET ALMOST OVERNIGHT.\n" +
          "FOR DECADES IT WAS AN INDUSTRIAL DISTRICT OF WAREHOUSES AND RESIDENTIAL HOTELS.\n" +
          "THEN, IN 1936, THE HILL WAS LEVELED AND CUT AGAIN —\n" +
          "THIS TIME FOR THE ANCHORAGE OF THE BRAND-NEW BAY BRIDGE,\n" +
          "WHOSE SUSPENSION SPAN LANDS RIGHT HERE.\n" +
          "AND TODAY? AFTER REZONINGS IN 1985 AND 2005, RINCON HILL HAS BECOME\n" +
          "THE CITY'S HIGH-RISE RESIDENTIAL TOWER DISTRICT —\n" +
          "HOME TO ONE RINCON AND THE TALLEST RESIDENTIAL TOWERS IN SAN FRANCISCO,\n" +
          "ALL STANDING AT THE FOOT OF THE BAY BRIDGE.\n" +
          "FROM MANSION HILL TO SKYLINE — THAT'S THE ARC OF THIS PLACE.",
        broll: ["The Bay Bridge anchorage rising from the neighborhood", "Archival idea: old Rincon Hill mansions / the Second Street Cut", "The modern tower cluster against the sky"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "RINCON HILL IS THE WESTERN LAND ANCHORAGE OF THE BAY BRIDGE —\n" +
          "THE ENTIRE SUSPENSION SPAN TO YERBA BUENA ISLAND IS QUITE LITERALLY\n" +
          "TIED DOWN INTO THE GROUND BENEATH THIS NEIGHBORHOOD.\n" +
          "THE ONE RINCON HILL SOUTH TOWER, FINISHED IN 2008,\n" +
          "RISES 60 STORIES AND ABOUT 641 FEET AT THE HILL'S APEX —\n" +
          "FOR YEARS THE TALLEST RESIDENTIAL TOWER ON THE WEST COAST.\n" +
          "BEFORE ANY OF THAT, IN 1869, CREWS DUG A CUT ROUGHLY 100 FEET DEEP\n" +
          "STRAIGHT THROUGH THE HILL ALONG SECOND STREET TO REACH THE WHARVES —\n" +
          "THE PROJECT THAT ENDED ITS MANSION ERA.\n" +
          "AND THE NAME ON THE NEW BANNERS — 'THE EAST CUT' — ONLY DATES TO 2015,\n" +
          "WHEN A COMMUNITY-BENEFIT DISTRICT UNITED RINCON HILL, FOLSOM STREET,\n" +
          "AND THE TRANSBAY AREA UNDER ONE NAME.\n" +
          "THIS IS A NEIGHBORHOOD THAT KEEPS REINVENTING ITSELF.",
        broll: ["The bridge cables landing into the anchorage", "One Rincon tower tight shot looking up", "An 'East Cut' banner / neighborhood sign"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "DOWN HERE ON THE DOWNTOWN BAYFRONT, RINCON HILL IS GENERALLY SUNNY —\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND RINCON HILL IS ONE OF THE BEST-CONNECTED PLACES\n" +
          "IN THE WHOLE CITY TO LIVE WITHOUT A CAR.\n" +
          "THE SALESFORCE TRANSIT CENTER — THE REGION'S GRAND TRANSIT HUB —\n" +
          "IS RIGHT HERE, WITH BAY BRIDGE BUS LINES TO THE EAST BAY RUNNING FROM IT.\n" +
          "EMBARCADERO BART AND MUNI METRO ARE JUST A FEW BLOCKS NORTH,\n" +
          "THE HISTORIC F-LINE STREETCAR RUNS ALONG THE EMBARCADERO,\n" +
          "AND MANY BUS LINES THREAD THROUGH THE NEIGHBORHOOD.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ONLY ABOUT SIX-TENTHS OF A MILE NORTH ALONG THE WATER —\n" +
          "GENUINELY CLOSE, YOUR GATEWAY TO EVERY FERRY ON THE BAY.\n" +
          "GOING TO THE EAST BAY? TAKE BART FROM EMBARCADERO\n" +
          "AND DOWNTOWN OAKLAND IS ABOUT FIFTEEN MINUTES —\n" +
          "OR HOP A TRANSBAY BUS OVER THE BRIDGE THAT STARTS RIGHT HERE.\n" +
          "HEADING NORTH TO MARIN? TAKE THE LARKSPUR FERRY FROM THE FERRY BUILDING,\n" +
          "ABOUT THIRTY MINUTES ON THE WATER — OR DRIVE THE GOLDEN GATE BRIDGE.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE MUNI TO THE CALTRAIN DEPOT\n" +
          "AT 4TH AND KING, AND CALTRAIN RUNS DOWN THE PENINSULA IN ABOUT FIFTY MINUTES —\n" +
          "OR IT'S 280 AND 101 RIGHT AT YOUR DOORSTEP BY CAR.\n" +
          "BOTTOM LINE: A MAJOR TRANSIT HUB, BART, FERRIES, AND THE BRIDGE —\n" +
          "ALL WITHOUT OWNING A CAR.",
        broll: [
          "The Salesforce Transit Center exterior; a Bay Bridge bus pulling out",
          "Embarcadero Station + the Ferry Building / a departing ferry",
          "A BART train; the Bay Bridge; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: Rincon Hill → Oakland / Larkspur / Peninsula with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        words: 110,
        script:
          "TWO HONEST NOTES ON THE GROUND ITSELF — AND I WON'T SUGARCOAT THESE.\n" +
          "RINCON HILL SITS ON LOW BAYFRONT FILL RIGHT AT THE FOOT OF THE BRIDGE,\n" +
          "SO PARTS OF IT FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE\n" +
          "FOR LIQUEFACTION — THE SHAKING-RELATED RISK THAT COMES WITH MADE GROUND.\n" +
          "IT IS ALSO WITHIN A MAPPED TSUNAMI HAZARD ZONE, GIVEN HOW LOW AND CLOSE\n" +
          "TO THE WATER IT IS. NOW — THESE TOWERS ARE ENGINEERED TO CURRENT CODE,\n" +
          "BUILT FOR EXACTLY THIS GROUND, AND THAT'S A REAL REASSURANCE.\n" +
          "STILL, IT'S SOMETHING EVERY BUYER SHOULD REVIEW WITH THEIR INSPECTOR AND INSURER.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BUILDING BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the low ground / the water's edge", "The towers against the bay", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "RINCON HILL PUTS YOU STEPS FROM THE EMBARCADERO WATERFRONT AND ALL OF SOMA —\n" +
          "WATERFRONT DINING, CAFÉS, AND THE WHOLE DOWNTOWN SCENE RIGHT OUTSIDE THE LOBBY.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY RINCON HILL DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A LOCK-THE-DOOR, RIDE-THE-ELEVATOR-DOWN,\n" +
          "AND-YOU'RE-IN-THE-MIDDLE-OF-EVERYTHING KIND OF PLACE.",
        broll: ["Waterfront restaurant tables at dusk; the bay beyond", "The Embarcadero promenade; people out along the water", "A lit tower lobby / street life at the base of the towers"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: RINCON HILL IS A HIGH-RISE NEIGHBORHOOD, PLAIN AND SIMPLE —\n" +
          "GLASS RESIDENTIAL TOWERS FULL OF MODERN CONDOS,\n" +
          "FROM EFFICIENT ONE-BEDROOMS TO FULL-FLOOR HIGH-FLOOR HOMES WITH BAY VIEWS.\n" +
          "IF YOU WANT A VICTORIAN, THIS ISN'T THAT NEIGHBORHOOD — THIS IS SKYLINE LIVING.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR RINCON HILL ON MY SITE —\n" +
          "CURRENT CONDO MEDIANS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A glass tower entrance; a high-floor view out over the bay", "A 'For Sale' sign at a tower", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS ON RINCON HILL?\n" +
          "SOMEONE WHO WANTS A MODERN HOME IN THE SKY, SUN AND BAY VIEWS,\n" +
          "AND THE WHOLE REGION A TRANSIT HUB AWAY, WITHOUT EVER NEEDING A CAR.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY RINCON HILL NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING RINCON HILL HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass along the bayfront (you, relaxed, not pitching)", "A quiet look up at the towers against the sky", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the hero towers, the bridge anchorage, the transit center, the bayfront, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the transit center entrance, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Rincon Hill page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Rincon Hill + South Beach + the Financial District in one bayfront loop.",
  },
"Corona Heights": {
    aka: "Museum Hill",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Corona%20Heights&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Corona Heights)",
    route: {
      // Route stays ENTIRELY within the Corona Heights boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "States St trailhead", note: "Start — the step-and-trail entrance to the park from the residential blocks", coord: [-122.4400, 37.7640] },
        { n: 2, name: "Corona Heights Park summit viewpoint", note: "The craggy red-chert peak — a former quarry — with a 360° view", coord: [-122.4385, 37.7656] },
        { n: 3, name: "Randall Museum", note: "Free, kid-friendly museum on the slope at 199 Museum Way", coord: [-122.4388, 37.7649] },
        { n: 4, name: "Roosevelt Way Victorian block", note: "Grand Victorians on the blocks below, between the Castro and Buena Vista", coord: [-122.4404, 37.7635] },
        { n: 5, name: "Museum Way steps", note: "Step-access climb back up the hill — the terraced, stair-built grid", coord: [-122.4378, 37.7644] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON THE RED-ROCK SUMMIT OF CORONA HEIGHTS, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE CORONA HEIGHTS? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, the sunny red summit in the next", "You climbing the last steps onto the rocky peak into frame", "The craggy red-chert outcrop + the skyline behind to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? CORONA HEIGHTS IS A HILL JUST ABOVE THE CASTRO,\n" +
          "TUCKED BETWEEN THE CASTRO BELOW AND BUENA VISTA TO THE NORTH,\n" +
          "WITH THE HAIGHT OVER THE SHOULDER OF THE HILL.\n" +
          "THE CROWN IS CORONA HEIGHTS PARK — A CRAGGY, RED-CHERT SUMMIT,\n" +
          "A FORMER QUARRY, WITH A FULL 360-DEGREE VIEW OF THE CITY AND THE BAY.\n" +
          "THE LAND RUNS FROM ABOUT 150 FEET UP DOWN IN THE NEIGHBORHOOD\n" +
          "TO AROUND 480 FEET AT THE ROCKS — SO LET'S BE HONEST ABOUT THE GRADE.\n" +
          "THIS IS A STEEP, ROCKY HILL. THE SUMMIT ITSELF IS REACHED BY TRAILS AND STEPS,\n" +
          "AND THE GRADES HERE PASS WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "MANY OF THE HOMES ARE TERRACED UP A FLIGHT OF STEPS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE ROUTES THAT WORK TAKE SOME PLANNING — IT'S WORTH CHECKING HOME BY HOME.\n" +
          "BUT HERE'S THE TRADE: FOR THAT CLIMB, YOU GET SOME OF THE HUGEST,\n" +
          "MOST WIDE-OPEN VIEWS IN THE ENTIRE CITY, RIGHT OUTSIDE YOUR DOOR.",
        broll: ["Slow pan up the red-rock summit; the 360° skyline reveal", "Wide establishing shot showing the hill above the Castro + Buena Vista", "A genuinely steep step-street climbing the hill (show the grade)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. THIS HILL WAS ONCE CALLED ROCK HILL —\n" +
          "AND IN THE LATE 1800s IT WAS A WORKING QUARRY.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "AROUND 1899, THE GRAY BROTHERS BEGAN BLASTING INTO THE SLOPE\n" +
          "FOR THEIR QUARRY AND BRICK FACTORY —\n" +
          "AND THAT BLASTING IS WHAT EXPOSED THE DEEP-RED FRANCISCAN CHERT\n" +
          "THAT STILL DEFINES THE CRAGGY SUMMIT TODAY.\n" +
          "THEN CAME THE TURN. IN 1941, SAN FRANCISCO'S FIRST SUPERINTENDENT\n" +
          "OF RECREATION, JOSEPHINE D. RANDALL, PERSUADED THE CITY\n" +
          "TO BUY THE OLD QUARRY FOR PUBLIC RECREATION —\n" +
          "AND THE RENAMED CORONA HEIGHTS OPENED AS A PARK.\n" +
          "A DECADE LATER, IN 1951, THE JOSEPHINE D. RANDALL JUNIOR MUSEUM\n" +
          "OPENED ON THE SLOPE, IN A BUILDING BY ARCHITECT WILLIAM MERCHANT —\n" +
          "CARRYING FORWARD RANDALL'S VISION OF A HANDS-ON MUSEUM FOR CHILDREN.\n" +
          "ON THE BLOCKS BELOW, GRAND VICTORIANS WENT UP AS THE CITY GREW AROUND THE HILL.\n" +
          "SPEND TIME HERE, AND YOU'RE STANDING ON A QUARRY TURNED PUBLIC TREASURE.",
        broll: ["The exposed red-chert rock face up close", "The Randall Museum building on the slope", "Victorian facades on the blocks below the park"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THAT JAGGED RED PEAK ISN'T NATURAL SHADING — IT'S EXPOSED FRANCISCAN CHERT,\n" +
          "BLASTED BARE BY A BRICK FACTORY MORE THAN A CENTURY AGO.\n" +
          "THE RANDALL MUSEUM ON THE SLOPE IS FREE, AND IT'S BEEN OFFERING\n" +
          "HANDS-ON SCIENCE, ART, AND NATURE PROGRAMS FOR KIDS SINCE 1951.\n" +
          "THE PARK PACKS A LOT INTO ROUGHLY SIXTEEN ACRES —\n" +
          "TRAILS, A PLAYGROUND, TENNIS COURTS, AND A DEDICATED OFF-LEASH DOG AREA.\n" +
          "AND THE HILL HAS A SECRET IDENTITY: LOCALS STILL CALL IT MUSEUM HILL.\n" +
          "FOR A SUMMIT THIS DRAMATIC, IT STAYS REMARKABLY QUIET AND RESIDENTIAL —\n" +
          "A KNOCKOUT VIEW HIDING IN A CALM LITTLE POCKET OF THE CITY.",
        broll: ["Red-chert rock tight shot", "Randall Museum sign / entrance", "The dog play area + playground; the view past the courts"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "CORONA HEIGHTS IS A HILL JUST ABOVE THE CASTRO, AND IT SHARES\n" +
          "THAT SAME SUNNY CASTRO MICROCLIMATE — ONE OF THE CITY'S BRIGHTER POCKETS.\n" +
          "WHILE THE AVENUES OUT WEST DISAPPEAR INTO SUMMER FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. EVEN ON A HILL, CORONA HEIGHTS IS WELL CONNECTED.\n" +
          "THE 37-CORBETT RUNS ALONG ROOSEVELT WAY RIGHT PAST THE PARK,\n" +
          "AND THE 24 AND 33 BUSES THREAD THE NEARBY HILLS.\n" +
          "DOWN THE HILL IN THE CASTRO IS CASTRO MUNI METRO STATION,\n" +
          "WITH THE K, L, AND M LINES RUNNING UNDERGROUND STRAIGHT DOWNTOWN.\n" +
          "NEAREST BART IS 16TH AND MISSION, A SHORT HOP EAST.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT THREE-AND-A-HALF MILES NORTHEAST,\n" +
          "ROUGHLY TWENTY-FIVE MINUTES TAKING THE MUNI METRO FROM THE CASTRO TO EMBARCADERO,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? FROM EMBARCADERO, TAKE BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES DOOR TO PLATFORM.\n" +
          "BY CAR, THE BAY BRIDGE PUTS YOU IN OAKLAND IN TWENTY TO TWENTY-FIVE.\n" +
          ...
          "BOTTOM LINE: WATER, RAIL, AND THREE BRIDGES — ALL WITHOUT OWNING A CAR.",
        broll: [
          "The 37-Corbett passing the park; Castro Station entrance down the hill",
          "Embarcadero Station + the Ferry Building / a departing ferry",
          "A BART train; the Bay Bridge; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: Corona Heights → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS FIRST: CORONA HEIGHTS IS A HIGH, ROCKY HILL, WELL ABOVE THE BAY,\n" +
          "SO IT IS NOT IN A TSUNAMI HAZARD ZONE — CROSS THAT WORRY OFF THE LIST.\n" +
          "LIKE MUCH OF HILLY SAN FRANCISCO, PARTS OF THE NEIGHBORHOOD\n" +
          "DO FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THAT'S STANDARD FOR THE CITY'S SLOPES, AND IT'S SOMETHING\n" +
          ...
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the rocky hillside / the city below", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "CORONA HEIGHTS ITSELF IS QUIET AND RESIDENTIAL — THAT'S THE WHOLE APPEAL —\n" +
          "BUT THE SHOPS, CAFES, AND RESTAURANTS ARE JUST DOWN IN THE CASTRO,\n" +
          "A QUICK TRIP DOWNHILL FOR COFFEE, BRUNCH, DINNER, OR A NIGHT OUT.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE BEST\n" +
          "RESTAURANTS AND BARS NEARBY RIGHT ON MY CORONA HEIGHTS DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: A CALM HILL TO COME HOME TO, WITH THE LIVELY CASTRO MINUTES AWAY.",
        broll: ["The quiet residential blocks; a café window down in the Castro at dusk", "The strip below lit up; people on the sidewalk", "A classic neon sign down the hill (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: CORONA HEIGHTS IS CLASSIC SAN FRANCISCO —\n" +
          "GRAND VICTORIANS AND EDWARDIANS ON THE BLOCKS BELOW THE PARK,\n" +
          "TERRACED UP THE HILL ON QUIET, VIEW-RICH STREETS.\n" +
          "IT RUNS FROM A VIEW CONDO TO A FULLY RESTORED VICTORIAN SHOWPIECE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR CORONA HEIGHTS ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A painted Victorian below the park, a flats building, a modern view condo", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN CORONA HEIGHTS?\n" +
          "SOMEONE WHO WANTS A QUIET HILL, KNOCKOUT VIEWS, AND THE WHOLE BAY AREA\n" +
          "A TRAIN OR A FERRY AWAY, WITH THE LIVELY CASTRO JUST DOWN THE SLOPE.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY CORONA HEIGHTS NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING CORONA HEIGHTS HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass on the summit (you, relaxed, not pitching)", "A quiet look out over the city from the rocks", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route up the trail and steps, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the hero red summit, the 360° view, the Randall Museum, and the Victorian blocks in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Park signs, the museum entrance, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Corona Heights page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Corona Heights + Castro + Buena Vista in one morning loop.",
  },
"Bayview": {
    aka: "Bayview–Hunters Point",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Bayview&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Bayview)",
    route: {
      // Route stays ENTIRELY within the Bayview boundary (verified against the
      // neighborhood polygon). Coords approximate — snap to the sidewalk grid for the final cut.
      spots: [
        { n: 1, name: "Third & Palou — the Third St corridor", note: "Start — the heart of the commercial corridor, sun out", coord: [-122.3905, 37.7340] },
        { n: 2, name: "Bayview Opera House", note: "4705 Third St — the city's oldest theatre, 1888", coord: [-122.3899, 37.7335] },
        { n: 3, name: "Bayview Hill viewpoint", note: "The hilltop on the south rim — sweeping bay views", coord: [-122.3931, 37.7264] },
        { n: 4, name: "T-Third at Revere/Shafter", note: "The Muni Metro T line straight up Third St downtown", coord: [-122.3886, 37.7318] },
        { n: 5, name: "Quesada Ave — residential block", note: "The garden-lined residential streets above the corridor", coord: [-122.3930, 37.7370] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON THIRD STREET IN THE BAYVIEW, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE THE BAYVIEW? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Third St in the next", "You moving up Third St into frame", "The Bayview Opera House facade to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? THE BAYVIEW SITS IN SAN FRANCISCO'S SOUTHEAST CORNER,\n" +
          "DOWN ALONG THE BAY, WITH POTRERO HILL AND DOGPATCH TO THE NORTH\n" +
          "AND HUNTERS POINT JUTTING INTO THE WATER TO THE EAST.\n" +
          "THE MAIN SPINE IS THIRD STREET, A LONG COMMERCIAL CORRIDOR\n" +
          "RUNNING ACROSS THE FLAT FLATLAND OF THE NEIGHBORHOOD.\n" +
          "THE LAND RUNS FROM SEA LEVEL DOWN ON THE CORRIDOR\n" +
          "UP TO ABOUT 270 FEET ON BAYVIEW HILL AND THE HUNTERS POINT RIDGE.\n" +
          "ALONG THIRD STREET THE GRADE IS FLAT AND EASY TO GET AROUND —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "BUT THE BLOCKS THAT CLIMB UP BAYVIEW HILL AND HUNTERS POINT GET STEEP FAST,\n" +
          "QUICKLY PASSING WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE FLAT CORRIDOR IS YOUR FRIEND; THE HILLS ARE A CLIMB.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY OF THESE HOUSES SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan up Third St; street signs along the corridor", "Wide establishing shot showing the flatland + the Bayview Hill ridge", "A genuinely steep cross-street climbing up Bayview Hill (show the grade)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. THE BAYVIEW GREW UP AROUND BUTCHERTOWN —\n" +
          "THE OLD SLAUGHTERHOUSE DISTRICT WHERE CATTLE WERE ONCE DRIVEN\n" +
          "DOWN THIRD STREET — AND THE HEAVY INDUSTRY OF THE SOUTHEASTERN FLATS.\n" +
          "DURING WORLD WAR TWO, THOUSANDS OF AFRICAN-AMERICAN WORKERS CAME\n" +
          "TO LABOR AT THE HUNTERS POINT NAVAL SHIPYARD,\n" +
          "AND THE NEIGHBORHOOD BECAME THE HEART OF BLACK SAN FRANCISCO.\n" +
          "FOR DECADES THE AREA WAS UNDERSERVED BY TRANSIT,\n" +
          "UNTIL THE THIRD STREET LIGHT RAIL PROJECT BROUGHT THE MUNI METRO T LINE\n" +
          "TO THE CORRIDOR IN 2007.\n" +
          "TODAY THE THIRD STREET CORRIDOR HOLDS THE LARGEST CONCENTRATION\n" +
          "OF BLACK-OWNED BUSINESSES IN THE CITY,\n" +
          "ANCHORED BY THE BAYVIEW OPERA HOUSE — BUILT IN 1888,\n" +
          "REPUTED TO BE THE OLDEST SURVIVING THEATRE IN SAN FRANCISCO,\n" +
          "A CITY LANDMARK AND ON THE NATIONAL REGISTER OF HISTORIC PLACES.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING IN A NEIGHBORHOOD\n" +
          "WITH DEEP, LIVING CULTURAL ROOTS.",
        broll: ["The Bayview Opera House at 4705 Third St", "Black-owned storefronts along the Third St corridor", "Archival nod: the old shipyard / Butchertown industry"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THAT THEATRE ON THIRD STREET — THE BAYVIEW OPERA HOUSE —\n" +
          "DATES TO 1888 AND IS REPUTED TO BE THE OLDEST SURVIVING THEATRE\n" +
          "IN ALL OF SAN FRANCISCO, NOW BEAUTIFULLY RESTORED.\n" +
          "THE NAME 'BUTCHERTOWN' WASN'T A NICKNAME — COWBOYS REALLY DID\n" +
          "DRIVE CATTLE DOWN THIRD STREET TO THE CITY'S OLD SLAUGHTERHOUSE DISTRICT.\n" +
          "THE WWII-ERA HUNTERS POINT NAVAL SHIPYARD DREW THOUSANDS OF\n" +
          "AFRICAN-AMERICAN WORKERS, SHAPING THIS INTO THE HEART OF BLACK SAN FRANCISCO.\n" +
          "AND THE T-THIRD LIGHT RAIL ONLY ARRIVED IN 2007 —\n" +
          "FINALLY CONNECTING A CORRIDOR THAT WENT UNDERSERVED FOR DECADES.\n" +
          "THIS IS A NEIGHBORHOOD WITH MORE HISTORY PER BLOCK THAN ALMOST ANYWHERE IN THE CITY.",
        broll: ["Bayview Opera House detail / marquee", "Third St corridor wide shot", "A T-Third train gliding up Third St"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "THE BAYVIEW IS AMONG THE WARMEST, SUNNIEST, LEAST-FOGGY NEIGHBORHOODS\n" +
          "IN THE WHOLE CITY.\n" +
          "WHILE THE AVENUES OUT WEST DISAPPEAR INTO SUMMER FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND THE BAYVIEW IS BETTER CONNECTED\n" +
          "THAN A LOT OF PEOPLE EXPECT.\n" +
          "RIGHT HERE ON THIRD STREET IS THE T-THIRD MUNI METRO,\n" +
          "RUNNING STRAIGHT UP THIRD STREET TO DOWNTOWN.\n" +
          "THE 24, 44, AND 54 BUSES THREAD ACROSS THE NEIGHBORHOOD AND THE HILLS,\n" +
          "AND CALTRAIN STOPS AT THE BAYVIEW AND 22ND STREET STATIONS NEARBY.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT FOUR AND A HALF MILES NORTH,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? TAKE THE T-THIRD DOWNTOWN AND HOP BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES DOOR TO PLATFORM.\n" +
          "BY CAR, THE BAY BRIDGE PUTS YOU IN OAKLAND IN TWENTY TO TWENTY-FIVE.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE CALTRAIN FROM THE BAYVIEW STATION,\n" +
          "AND IT RUNS DOWN TO PALO ALTO IN ABOUT FORTY TO FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101, WITH 280 RIGHT NEARBY.\n" +
          "BOTTOM LINE: LIGHT RAIL, CALTRAIN, WATER, AND THREE BRIDGES —\n" +
          "ALL WITHOUT OWNING A CAR.",
        broll: [
          "A T-Third train on Third St; the platform canopies",
          "Embarcadero Station + the Ferry Building / a departing ferry",
          "A BART train; the Bay Bridge; the Golden Gate Bridge; a Caltrain at the Bayview station",
          "Simple motion-graphic map: Bayview → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "PARTS OF THE BAYVIEW NEAR THE OLD SHIPYARD AND THE BAYFRONT\n" +
          "SIT ON LOW, FILLED LAND ALONG THE WATER.\n" +
          "THAT MEANS THOSE BAYSIDE BLOCKS DO FALL WITHIN A STATE-DESIGNATED\n" +
          "SEISMIC HAZARD ZONE — FOR LIQUEFACTION — AND WITHIN A TSUNAMI HAZARD ZONE.\n" +
          "THE INLAND HILLS OF BAYVIEW HILL SIT HIGHER AND DRIER,\n" +
          "WELL ABOVE THAT EXPOSURE.\n" +
          "NONE OF THIS IS A DEAL-BREAKER — IT'S STANDARD FOR THE CITY'S BAYSIDE FLATS,\n" +
          "AND IT'S SOMETHING EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing from the flat corridor up to the higher hill", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "THE THIRD STREET CORRIDOR IS THE BEATING HEART OF THE BAYVIEW —\n" +
          "COFFEE, SOUL FOOD, NEIGHBORHOOD KITCHENS, AND A GROWING SCENE\n" +
          "ANCHORED BY THE LARGEST CONCENTRATION OF BLACK-OWNED BUSINESSES IN THE CITY.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY BAYVIEW DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A REAL, ROOTED, COMMUNITY-FIRST KIND OF PLACE.",
        broll: ["Café tables; a busy kitchen window along Third St", "The Opera House lit up; people on the sidewalk", "A general corridor streetscape (not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: THE BAYVIEW OFFERS SOME OF THE MOST SPACE FOR THE MONEY\n" +
          "IN SAN FRANCISCO — STANDALONE HOUSES WITH YARDS,\n" +
          "CLASSIC SINGLE-FAMILY HOMES ON THE HILL, AND NEWER CONDOS\n" +
          "AND TOWNHOMES RISING ALONG THE WATERFRONT REDEVELOPMENT.\n" +
          "IT RUNS FROM A FIRST STARTER HOME TO A FULLY REMODELED SHOWPIECE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR THE BAYVIEW ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A standalone house with a yard, a hillside home, a new townhome", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN THE BAYVIEW?\n" +
          "SOMEONE WHO WANTS SUN, SPACE, AND DEEP COMMUNITY ROOTS,\n" +
          "WITH LIGHT RAIL AND CALTRAIN PUTTING THE WHOLE BAY AREA WITHIN REACH.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY BAYVIEW NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING THE BAYVIEW HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass up Third St (you, relaxed, not pitching)", "A quiet look up toward Bayview Hill", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the Opera House, the Third St corridor, the T-Third line, street life, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the T-Third platform, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Bayview page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Bayview + Hunters Point + Dogpatch in one sunny morning loop.",
  },
"Hunters Point": {
    aka: "The Point",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Hunters%20Point&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Hunters Point)",
    route: {
      // Route stays ENTIRELY within the Hunters Point boundary (verified against
      // the neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Hunters Point ridge overlook", note: "Start — up top for the sweeping bay views", coord: [-122.3735, 37.7250] },
        { n: 2, name: "Shipyard artists' studios (451 Galvez)", note: "One of the largest artist communities in the country", coord: [-122.3680, 37.7300] },
        { n: 3, name: "Third Street corridor edge", note: "The T-Third Muni Metro line + the commercial spine", coord: [-122.3807, 37.7292] },
        { n: 4, name: "The San Francisco Shipyard — new block", note: "A mixed-income redevelopment block going up", coord: [-122.3705, 37.7290] },
        { n: 5, name: "Innes Ave residential street", note: "The housing-stock segment: hillside homes + new builds", coord: [-122.3760, 37.7270] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M UP ON THE HUNTERS POINT RIDGE, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE HUNTERS POINT? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Hunters Point in the next", "You moving up to the ridge overlook into frame", "The sweeping bay view to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? HUNTERS POINT SITS ON THE CITY'S FAR SOUTHEASTERN EDGE,\n" +
          "A HILL JUTTING OUT INTO THE BAY, JUST EAST OF BAYVIEW\n" +
          "AND SOUTH OF INDIA BASIN, WITH THE WATER WRAPPING AROUND THREE SIDES.\n" +
          "IT'S A RIDGE WITH REAL GRADES AND BIG VIEWS —\n" +
          "THE LAND CLIMBS FROM THE SHORELINE ROUGHLY ZERO TO TWO HUNDRED THIRTY FEET UP.\n" +
          "FROM THE TOP YOU GET ONE OF THE GREAT UNSUNG PANORAMAS IN THE CITY.\n" +
          "SOME OF THE REDEVELOPMENT BLOCKS DOWN LOWER ARE FLATTER\n" +
          "AND EASIER TO GET AROUND — FRIENDLY WHETHER YOU'RE PUSHING A STROLLER\n" +
          "OR ROLLING A WHEELCHAIR.\n" +
          "BUT THIS IS A HILL, SO BE HONEST ABOUT THE GRADES:\n" +
          "MANY OF THE OLDER RESIDENTIAL STREETS CLIMB FAST,\n" +
          "QUICKLY PASSING WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE NEWER FLATTER BLOCKS ARE YOUR FRIEND; THE UPPER STREETS ARE A CLIMB.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY OF THE HILLSIDE HOUSES SIT UP A FLIGHT OF STEPS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan across the bay from the ridge; street signs on the hill", "Wide establishing shot showing the point jutting into the bay", "A genuinely steep cross-street climbing the hill (show the grade)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. HUNTERS POINT IS A HILLTOP WITH HUGE BAY VIEWS\n" +
          "AND DEEP AFRICAN AMERICAN HERITAGE.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "THE HISTORIC HUNTERS POINT SHIPYARD ANCHORS THE STORY —\n" +
          "A WORLD-CLASS SET OF DRYDOCKS DATING TO THE 1860s\n" +
          "THAT THE U.S. NAVY TOOK OVER IN 1940.\n" +
          "DURING WORLD WAR II, THE HUNTERS POINT NAVAL SHIPYARD\n" +
          "EMPLOYED ROUGHLY EIGHTEEN THOUSAND PEOPLE,\n" +
          "DRAWING A LARGE BLACK WORKFORCE IN THE WARTIME GREAT MIGRATION\n" +
          "THAT PUT DOWN LASTING ROOTS RIGHT HERE.\n" +
          "WHEN THE YARD CLOSED IN 1974, THE COMMUNITY HELD ON,\n" +
          "AND THE OLD SHIPYARD FOUND A SECOND LIFE:\n" +
          "TODAY IT HOLDS THE ARTISTS' STUDIOS AT THE SHIPYARD —\n" +
          "ONE OF THE LARGEST ARTIST COMMUNITIES IN THE COUNTRY.\n" +
          "AND NOW A LARGE MIXED-INCOME REDEVELOPMENT IS UNDERWAY,\n" +
          "REBUILDING THE FORMER NAVY LAND INTO A NEW WATERFRONT COMMUNITY.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING IN LIVING HISTORY —\n" +
          "AND WATCHING THE NEXT CHAPTER GO UP AT THE SAME TIME.",
        broll: ["The old shipyard gates / drydocks", "451 Galvez Ave — the artist studios", "A new redevelopment block rising on the former Navy land"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THIS IS A HILLTOP WITH HUGE BAY VIEWS HIDING IN PLAIN SIGHT —\n" +
          "ONE OF THE LAST CORNERS OF THE CITY MOST PEOPLE HAVE NEVER EXPLORED.\n" +
          "THE DRYDOCKS HERE WERE PROMOTED AS ONE OF THE GREATEST SHIPYARDS ON EARTH\n" +
          "BY THE EARLY 1900s, AND THE WWII NAVAL SHIPYARD\n" +
          "BUILT A PROUD, ENDURING AFRICAN AMERICAN COMMUNITY THAT'S STILL HERE.\n" +
          "TUCKED INSIDE THAT OLD SHIPYARD ARE THE ARTISTS' STUDIOS —\n" +
          "HUNDREDS OF WORKING ARTISTS, ONE OF THE LARGEST SUCH COMMUNITIES IN THE COUNTRY,\n" +
          "WHO THROW OPEN THEIR DOORS FOR FREE OPEN STUDIOS EACH SPRING AND FALL.\n" +
          "AND THE WHOLE WATERFRONT IS BEING REIMAGINED RIGHT NOW —\n" +
          "A LARGE MIXED-INCOME REDEVELOPMENT KNITTING NEW HOMES, PARKS, AND SHORELINE TOGETHER.\n" +
          "THIS IS A NEIGHBORHOOD IN THE MIDDLE OF ITS NEXT GREAT CHAPTER.",
        broll: ["The bay view from the top, tight", "Artist studio doors / Open Studios crowd", "Cranes and new construction on the shipyard land"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "HUNTERS POINT IS ONE OF THE SUNNIEST, WARMEST, LEAST-FOGGY CORNERS OF THE CITY.\n" +
          "WHILE THE AVENUES OUT WEST DISAPPEAR INTO SUMMER FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND HUNTERS POINT IS MORE CONNECTED\n" +
          "THAN PEOPLE EXPECT FOR A CORNER THIS FAR OUT.\n" +
          "DOWN ON THIRD STREET RUNS THE T-THIRD MUNI METRO,\n" +
          "LIGHT RAIL THAT CARRIES YOU STRAIGHT UP THROUGH MISSION BAY TO DOWNTOWN.\n" +
          "THE 19, THE 44, AND THE 54 BUSES THREAD THROUGH THE HILLS AND THE FLATS,\n" +
          "AND CALTRAIN IS NEARBY FOR THE RUN DOWN THE PENINSULA.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT FIVE MILES NORTH,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? TAKE THE T-THIRD UP TOWARD DOWNTOWN\n" +
          "AND HOP BART — DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES FROM THERE.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE CALTRAIN NEARBY,\n" +
          "AND IT RUNS DOWN TO PALO ALTO IN ABOUT FORTY TO FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: WATER, RAIL, AND THREE BRIDGES — ALL WITHOUT OWNING A CAR.",
        broll: [
          "The T-Third light rail on Third St; a bus climbing the hill",
          "The Ferry Building / a departing ferry",
          "A BART train; the Bay Bridge; the Golden Gate Bridge; a Caltrain",
          "Simple motion-graphic map: Hunters Point → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        words: 110,
        script:
          "NOW SOME HONEST, FACTUAL NOTES ON THE GROUND ITSELF.\n" +
          "PARTS OF HUNTERS POINT FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE,\n" +
          "AND THE LOW-LYING SHORELINE EDGE IS WITHIN A TSUNAMI HAZARD ZONE —\n" +
          "BOTH STANDARD THINGS EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "AND PLAINLY: THE FORMER HUNTERS POINT NAVAL SHIPYARD HAS A WELL-DOCUMENTED\n" +
          "ENVIRONMENTAL CLEANUP AND REMEDIATION HISTORY OVERSEEN BY THE E-P-A AND THE NAVY.\n" +
          "I'M NOT GOING TO SPECULATE — THAT WOULDN'T BE FAIR TO YOU OR THE NEIGHBORHOOD.\n" +
          "WHAT I'LL SAY IS THIS: ANY BUYER SHOULD REVIEW THE OFFICIAL ENVIRONMENTAL RECORDS\n" +
          "AND THE SELLER DISCLOSURES CAREFULLY.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S DETAILS PAGE,\n" +
          "ALONG WITH POINTERS TO THE OFFICIAL EPA AND NAVY RESOURCES,\n" +
          "SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the hillside and the shoreline below", "Edit: the seismic + tsunami toggles on your fog map", "Edit: lower-third pointing to the details page + official EPA/Navy resources"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "HUNTERS POINT AND THE BLOCKS AROUND IT HAVE A GROWING,\n" +
          "DEEPLY LOCAL FOOD SCENE — SOUL FOOD, NEIGHBORHOOD CAFES,\n" +
          "AND A FEW SPOTS THAT HAVE BECOME REAL COMMUNITY ANCHORS.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND SPOTS RIGHT ON MY HUNTERS POINT DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A TIGHT-KNIT, KNOW-YOUR-NEIGHBORS KIND OF PLACE\n" +
          "WITH THE WATER AND THE ARTIST STUDIOS RIGHT THERE.",
        broll: ["Café tables; a busy kitchen window", "People out on the sidewalk near Third St", "The artist studios / a community gathering (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: HUNTERS POINT IS A NEIGHBORHOOD IN TRANSITION,\n" +
          "WHICH MEANS REAL VARIETY — OLDER HILLSIDE HOMES WITH BIG VIEWS,\n" +
          "AND BRAND-NEW CONDOS AND TOWNHOMES GOING UP IN THE SHIPYARD REDEVELOPMENT.\n" +
          "IT RUNS FROM A FIRST CONDO TO A VIEW HOME ON THE RIDGE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR HUNTERS POINT ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A hillside view home, a new townhome row, a modern condo entry", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN HUNTERS POINT?\n" +
          "SOMEONE WHO WANTS SUN, BIG BAY VIEWS, AND A FRONT-ROW SEAT\n" +
          "TO ONE OF THE CITY'S GREAT WORKS-IN-PROGRESS — WITHOUT EVER NEEDING A CAR.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY HUNTERS POINT NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING HUNTERS POINT HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass along the ridge (you, relaxed, not pitching)", "A quiet look out over the bay", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the hero bay view, the shipyard studios, the Third St corridor, street life, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the T-Third platform, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Hunters Point page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Hunters Point + Bayview + India Basin in one morning loop.",
  },
"Excelsior": {
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Excelsior&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Excelsior)",
    route: {
      // Route stays ENTIRELY within the Excelsior boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Mission & Persia — the commercial spine", note: "Start — the heart of the family-run immigrant restaurant row", coord: [-122.4316, 37.7234] },
        { n: 2, name: "Mission St corridor (toward Geneva)", note: "Pupuserías, taquerías, Filipino diners, Italian delis — daily life", coord: [-122.4351, 37.7201] },
        { n: 3, name: "Naples & Athens — streets of the world", note: "The 'around-the-world' residential grid: nations and capitals", coord: [-122.4280, 37.7220] },
        { n: 4, name: "London & Vienna — single-family blocks", note: "Classic Excelsior cottages on the named-streets grid", coord: [-122.4258, 37.7195] },
        { n: 5, name: "Excelsior Ave near the McLaren Park edge", note: "Where the grid climbs east toward the parkland", coord: [-122.4240, 37.7252] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON MISSION STREET IN THE EXCELSIOR, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE THE EXCELSIOR? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Mission St in the next", "You moving up Mission St into frame", "A street sign — Persia, Naples, or Madrid — to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? THE EXCELSIOR SITS IN THE CITY'S SOUTHEAST,\n" +
          "A SUNNY, WORKING-FAMILY HILLTOP TUCKED BELOW McLAREN PARK,\n" +
          "WITH THE OUTER MISSION TO THE WEST AND CROCKER AMAZON TO THE SOUTH.\n" +
          "THE MAIN SPINE IS MISSION STREET, RUNNING THROUGH THE HEART OF IT,\n" +
          "AND THE FAMOUS 'STREETS-OF-THE-WORLD' GRID CLIMBS UP ON EITHER SIDE.\n" +
          "THE LAND RUNS ROUGHLY 170 TO 480 FEET UP, AND HERE'S THE HONEST READ:\n" +
          "THE MISSION STREET VALLEY IS FAIRLY LEVEL AND EASY TO GET AROUND —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "BUT THIS IS SAN FRANCISCO, SO THE EDGES CLIMB FAST:\n" +
          "THE SURROUNDING STREETS RISE TOWARD THE HILLS AND McLAREN PARK,\n" +
          "AND PLENTY OF THOSE BLOCKS PASS WHAT THE A-D-A CONSIDERS\n" +
          "AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE MISSION STREET CORRIDOR IS YOUR FRIEND; THE UPPER BLOCKS ARE A CLIMB.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY OF THESE SINGLE-FAMILY HOUSES SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan up Mission St; street signs at Persia & Mission", "Wide establishing shot showing the valley + McLaren Park ridge", "A genuinely steep cross-street climbing toward the park (show the grade)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. THE EXCELSIOR IS ONE OF THE CITY'S MOST DIVERSE,\n" +
          "WORKING-FAMILY NEIGHBORHOODS — AND IT WAS BUILT THAT WAY ON PURPOSE.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "IN 1869, THE EXCELSIOR HOMESTEAD ASSOCIATION LAID OUT A SUBDIVISION\n" +
          "FAR BEYOND THE BUILT-UP CITY, MEANT TO LURE WORKING FAMILIES\n" +
          "OUT OF THE CROWDED INNER CITY WITH AFFORDABLE LOTS.\n" +
          "AND THEY GAVE IT AN UNFORGETTABLE STREET GRID —\n" +
          "NAMED FOR NATIONS AND THE GREAT CITIES OF THE WORLD:\n" +
          "PERSIA, NAPLES, ATHENS, VIENNA, PARIS, LONDON, MADRID, AND MORE.\n" +
          "EARLY RESIDENTS WERE LARGELY IRISH, GERMAN, AND ITALIAN\n" +
          "FARM AND DAIRY WORKERS, AND THE 1906 EARTHQUAKE DROVE A WAVE OF NEW BUYERS.\n" +
          "THROUGH THE 20TH CENTURY, ONE IMMIGRANT COMMUNITY AFTER ANOTHER\n" +
          "PUT DOWN ROOTS HERE, AND THE MISSION STREET CORRIDOR\n" +
          "BECAME THE NEIGHBORHOOD'S BEATING HEART.\n" +
          "AND A LOCAL NOTE I LOVE: THE GUITARIST CARLOS SANTANA GREW UP HERE.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING IN\n" +
          "A LIVING MAP OF WHO CAME TO SAN FRANCISCO TO BUILD A LIFE.",
        broll: ["Street signs — Naples, Athens, Vienna, London", "Mission St storefronts; family-run kitchens", "A row of classic single-family Excelsior cottages"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 150,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "THIS WHOLE PLACE IS AN ATLAS YOU CAN STAND IN —\n" +
          "THE 1869 PLAT NAMED THE STREETS FOR NATIONS AND WORLD CITIES,\n" +
          "SO YOU CAN CROSS FROM PARIS TO NAPLES TO ATHENS TO LONDON\n" +
          "WITHOUT EVER LEAVING THE SOUTHEAST CORNER OF SAN FRANCISCO.\n" +
          "IT WAS DESIGNED AS AN OUT-OF-TOWN SUBDIVISION OF AFFORDABLE,\n" +
          "SINGLE-FAMILY COTTAGES — A PLACE FOR WORKING FAMILIES TO OWN A HOME.\n" +
          "AND IT'S STILL ONE OF THE MOST DIVERSE NEIGHBORHOODS IN THE CITY —\n" +
          "ROUGHLY HALF OF RESIDENTS WERE BORN ABROAD,\n" +
          "WITH SPANISH, MANDARIN, AND TAGALOG AMONG THE LANGUAGES YOU'LL HEAR.\n" +
          "AND THAT MUSICAL CONNECTION I MENTIONED — CARLOS SANTANA\n" +
          "SPENT PART OF HIS YOUTH RIGHT HERE IN THESE STREETS.\n" +
          "THIS IS A NEIGHBORHOOD THAT QUIETLY HOLDS THE WHOLE WORLD.",
        broll: ["Tight shots of the world-city street signs", "A modest single-family cottage facade", "Mission St daily life — people, shopfronts, languages on the signage"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "THE EXCELSIOR SITS IN ONE OF THE CITY'S SUNNIER, WARMER POCKETS.\n" +
          "WHILE THE AVENUES OUT WEST DISAPPEAR INTO SUMMER FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND THE EXCELSIOR IS ONE OF THE EASIER PLACES\n" +
          "IN THE WHOLE CITY TO LIVE WITHOUT A CAR.\n" +
          "RIGHT AT THE EDGE IS BALBOA PARK BART, ON GENEVA AVENUE —\n" +
          "ONE OF THE BUSIEST BART STATIONS OUTSIDE DOWNTOWN.\n" +
          "ALONG MISSION STREET, THE 14-MISSION AND THE 14R RAPID RUN STRAIGHT INTO TOWN,\n" +
          "WITH THE 29, 52 EXCELSIOR, 54, AND 8 THREADING THROUGH THE HILLS.\n" +
          "AND THE J, K, AND M MUNI METRO LINES ALL MEET AT BALBOA PARK.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT FIVE AND A HALF MILES NORTH,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? FROM BALBOA PARK, HOP BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT THIRTY-FIVE MINUTES DOOR TO PLATFORM.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR.\n" +
          ...
          "BOTTOM LINE: WATER, RAIL, AND THREE BRIDGES — ALL WITHOUT OWNING A CAR.",
        broll: [
          "Balboa Park BART entrance; a 14-Mission bus on Mission St",
          "The Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: Excelsior → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS ON BOTH COUNTS HERE.\n" +
          "THE EXCELSIOR SITS WELL INLAND, UP ON THE CITY'S SOUTHERN HILLS,\n" +
          "SO IT IS NOT IN A TSUNAMI HAZARD ZONE — CROSS THAT WORRY OFF THE LIST.\n" +
          "AND UNLIKE A LOT OF HILLY SAN FRANCISCO, THE HEART OF THIS NEIGHBORHOOD\n" +
          "IS NOT MAPPED INSIDE A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THOUGH OF COURSE EVERY CALIFORNIA BUYER STILL REVIEWS QUAKE READINESS\n" +
          "WITH THEIR INSPECTOR AND INSURER, BLOCK BY BLOCK.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the hills / McLaren Park beyond", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "MISSION STREET THROUGH THE EXCELSIOR IS A GENUINE IMMIGRANT FOOD CORRIDOR —\n" +
          "FAMILY-RUN PUPUSERÍAS, TAQUERÍAS, FILIPINO DINERS, BÁNH MÌ SHOPS,\n" +
          "ITALIAN DELIS, AND BAKERIES, ONE AFTER ANOTHER DOWN THE STRIP.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND SPOTS RIGHT ON MY EXCELSIOR DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A RIGHT-OUTSIDE-YOUR-DOOR, LEAVE-THE-CAR-HOME KIND OF PLACE.",
        broll: ["Storefront after storefront on Mission St at dusk", "Steam off a griddle; a busy family-run counter", "General signage along the corridor (not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 115,
        script:
          "ON HOUSING: THE EXCELSIOR IS CLASSIC WORKING-FAMILY SAN FRANCISCO —\n" +
          "BLOCK AFTER BLOCK OF AFFORDABLE SINGLE-FAMILY HOMES\n" +
          "ON THAT STREETS-OF-THE-WORLD GRID, WITH SOME OF THE BETTER VALUE\n" +
          "YOU'LL FIND ANYWHERE IN THE CITY.\n" +
          "IT RUNS FROM A FIRST STARTER HOME TO A FULLY UPDATED FAMILY HOUSE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR THE EXCELSIOR ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A single-family cottage, a stucco home, a fixer on a named street", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN THE EXCELSIOR?\n" +
          "SOMEONE WHO WANTS SUN, SPACE, AND A REAL SINGLE-FAMILY HOME\n" +
          "IN A DIVERSE, WELCOMING CORNER OF THE CITY — WITH BART AT THE EDGE.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY EXCELSIOR NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING THE EXCELSIOR HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass down a named street (you, relaxed, not pitching)", "A quiet look up toward McLaren Park", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the Mission St corridor, the world-city street signs, single-family blocks, and street life in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the BART entrance, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Excelsior page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Excelsior + Crocker Amazon + Outer Mission in one morning loop.",
  },
"Portola": {
    aka: "the Garden District",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Portola&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Portola)",
    route: {
      // Route stays ENTIRELY within the Portola boundary (verified against the
      // neighborhood polygon). Coords approximate — snap to the sidewalk grid for the final cut.
      spots: [
        { n: 1, name: "San Bruno Ave & Woolsey", note: "Start — the multicultural Main Street strip, sun out", coord: [-122.4045, 37.7270] },
        { n: 2, name: "University Mound Nursery — 770 Woolsey St", note: "The last surviving redwood-and-glass greenhouses of the Garden District", coord: [-122.4030, 37.7258] },
        { n: 3, name: "Avenue Theatre — San Bruno Ave", note: "1927 movie house, the old Wurlitzer organ; building still stands", coord: [-122.4060, 37.7283] },
        { n: 4, name: "Bowdoin & Felton — single-family garden blocks", note: "Quiet uphill streets of low-slung homes with gardens", coord: [-122.4090, 37.7240] },
        { n: 5, name: "Mansell St — McLaren Park edge", note: "The green slopes of McLaren Park rising on the neighborhood's west side", coord: [-122.4115, 37.7227] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON SAN BRUNO AVENUE IN THE PORTOLA, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE THE PORTOLA? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny San Bruno Ave in the next", "You moving up San Bruno Ave into frame", "The multicultural strip — bakeries, taquerias, pho — to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? THE PORTOLA SITS IN SAN FRANCISCO'S SOUTHEAST CORNER,\n" +
          "EAST OF MCLAREN PARK AND UNIVERSITY MOUND, NORTH OF VISITACION VALLEY,\n" +
          "WITH THE BAYVIEW DOWNHILL TO THE EAST.\n" +
          "THE MAIN SPINE IS SAN BRUNO AVENUE, A BUSY, MULTICULTURAL SHOPPING STRIP\n" +
          "RUNNING ALONG THE FLOOR OF THE NEIGHBORHOOD.\n" +
          "THE LAND RUNS FROM ABOUT 20 FEET DOWN HERE\n" +
          "UP TO AROUND 400 FEET ON THE WESTERN HILLS.\n" +
          "ALONG SAN BRUNO AVENUE THE GRADE IS FAIRLY LEVEL AND EASY TO GET AROUND —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "BUT THE STREETS THAT CLIMB WEST TOWARD MCLAREN PARK AND UNIVERSITY MOUND\n" +
          "GET STEEP FAST, QUICKLY PASSING WHAT THE A-D-A CONSIDERS\n" +
          "AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE AVENUE AND THE FLATS ARE YOUR FRIEND; THE UPPER BLOCKS ARE A CLIMB.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY OF THESE SINGLE-FAMILY HOUSES SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan up San Bruno Ave; street signs at San Bruno & Woolsey", "Wide establishing shot showing the flats + the McLaren Park ridge", "A genuinely steep cross-street climbing west (show the grade)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. THE PORTOLA IS NAMED FOR GASPAR DE PORTOLÁ,\n" +
          "THE SPANISH EXPLORER WHOSE 1769 EXPEDITION FIRST SIGHTED SAN FRANCISCO BAY.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "IN THE EARLY 1900s, ITALIAN, MALTESE AND JEWISH IMMIGRANTS SETTLED HERE\n" +
          "AND BUILT GREENHOUSES TO GROW CUT FLOWERS FOR THE CITY.\n" +
          "BY THE 1920s, DOZENS OF FAMILY NURSERIES BLANKETED THESE HILLSIDES,\n" +
          "SUPPLYING MOST OF THE FLOWERS SOLD AT THE SAN FRANCISCO FLOWER MART —\n" +
          "AND EARNING THE PORTOLA ITS NICKNAME AS THE CITY'S GARDEN DISTRICT.\n" +
          "AFTER WORLD WAR TWO, MOST GROWERS MOVED SOUTH,\n" +
          "AND THE GREENHOUSES GAVE WAY TO AFFORDABLE SINGLE-FAMILY HOMES WITH GARDENS.\n" +
          "SAN BRUNO AVENUE GREW INTO THE NEIGHBORHOOD'S MAIN STREET,\n" +
          "A WORKING-FAMILY CORRIDOR OF SHOPS AND KITCHENS FROM AROUND THE WORLD.\n" +
          "TODAY THE PORTOLA IS ONE OF THE CITY'S MOST ASIAN-MAJORITY NEIGHBORHOODS,\n" +
          "WITH A DEEPLY MULTICULTURAL COMMERCIAL STRIP.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING IN A WORKING-CLASS\n" +
          "IMMIGRANT STORY THAT BUILT A QUIET, GROUNDED CORNER OF SAN FRANCISCO.",
        broll: ["San Bruno Ave storefronts — bakeries, taquerias, pho", "770 Woolsey St — the surviving University Mound Nursery greenhouses", "Rows of modest single-family homes with front gardens"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "IN 2016, A CITY RESOLUTION OFFICIALLY RECOGNIZED THE PORTOLA\n" +
          "AS SAN FRANCISCO'S GARDEN DISTRICT, HONORING ITS FLOWER-GROWING PAST.\n" +
          "AND THAT PAST IS STILL STANDING: THE GARIBALDI FAMILY'S\n" +
          "UNIVERSITY MOUND NURSERY AT 770 WOOLSEY STREET GREW ROSES\n" +
          "FOR THE FLOWER MART RIGHT UP UNTIL 1990 —\n" +
          "ITS REDWOOD-AND-GLASS GREENHOUSES ARE THE LAST OF THEIR KIND IN THE DISTRICT.\n" +
          "ON SAN BRUNO AVENUE, THE AVENUE THEATRE — A 1927 MOVIE HOUSE\n" +
          "FAMED FOR ITS WURLITZER ORGAN — CLOSED IN 1984, BUT THE BUILDING STILL STANDS.\n" +
          "AND JUST WEST RISES JOHN McLAREN PARK, THE CITY'S SECOND-LARGEST,\n" +
          "OVER THREE HUNDRED ACRES OF GREEN ON THE NEIGHBORHOOD'S DOORSTEP.\n" +
          "THIS IS A NEIGHBORHOOD WITH ITS HISTORY ROOTED RIGHT IN THE SOIL.",
        broll: ["The Woolsey St greenhouses, close on the redwood-and-glass frames", "The Avenue Theatre building on San Bruno Ave", "A wide green look across McLaren Park"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "THE PORTOLA SITS IN ONE OF THE CITY'S SUNNIEST, WARMEST POCKETS.\n" +
          "TUCKED INTO THE SOUTHEAST, SHELTERED FROM THE WORST OF THE OCEAN FOG,\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. THE PORTOLA IS WELL CONNECTED FOR ITS QUIET CORNER.\n" +
          "RIGHT ALONG SAN BRUNO AVENUE, THE 9-SAN BRUNO AND THE 9R RAPID\n" +
          "RUN THE LENGTH OF THE STRIP, AND THE 8-BAYSHORE, THE 23, AND THE 54\n" +
          "THREAD THROUGH THE NEIGHBORHOOD AND ITS HILLS.\n" +
          "THE T-THIRD LIGHT RAIL IS A BIT EAST TOWARD THE BAY,\n" +
          "AND YOUR NEAREST BART STATIONS ARE BALBOA PARK AND GLEN PARK.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT FIVE MILES NORTH,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? TAKE MUNI OVER TO BART —\n" +
          "AND DOWNTOWN OAKLAND IS ABOUT FORTY MINUTES OUT.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? CALTRAIN RUNS DOWN TO PALO ALTO\n" +
          "IN ABOUT FIFTY MINUTES — AND YOU'RE CLOSE TO BOTH 280 AND 101,\n" +
          "SO IT'S A QUICK ROUGHLY FIFTY BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: BUSES AT THE DOOR, RAIL CLOSE BY, AND THE FREEWAYS RIGHT THERE\n" +
          "WHEN YOU NEED THEM — A CONNECTED CORNER OF A QUIET CITY EDGE.",
        broll: [
          "A 9-San Bruno bus on San Bruno Ave; the strip behind it",
          "A T-Third train to the east; the Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; a Caltrain; the 280/101 interchange",
          "Simple motion-graphic map: Portola → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS FIRST: THE PORTOLA SITS INLAND AND UPHILL FROM THE BAY,\n" +
          "SO IT IS NOT IN A TSUNAMI HAZARD ZONE — CROSS THAT WORRY OFF THE LIST.\n" +
          "LIKE MUCH OF HILLY SAN FRANCISCO, PARTS OF THE NEIGHBORHOOD\n" +
          "DO FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THAT'S STANDARD FOR THE CITY'S SLOPES, AND IT'S SOMETHING\n" +
          ...
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the hillside / the flats below", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "SAN BRUNO AVENUE IS ONE OF THE CITY'S MOST GENUINELY MULTICULTURAL STRIPS —\n" +
          "FAMILY BAKERIES, TAQUERIAS, PHO, DUMPLINGS, AND CORNER MARKETS,\n" +
          "THE KIND OF EVERYDAY, UNFUSSY EATING THAT MAKES A NEIGHBORHOOD HOME.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND SHOPS RIGHT ON MY PORTOLA DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A REAL, ROOTED, RIGHT-OUTSIDE-YOUR-DOOR KIND OF PLACE.",
        broll: ["Bakery and taqueria windows on San Bruno Ave", "A busy corner market; people on the sidewalk", "The strip at dusk (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: THE PORTOLA IS CLASSIC SOUTHEAST SAN FRANCISCO —\n" +
          "AFFORDABLE SINGLE-FAMILY HOMES, MANY WITH GARDENS,\n" +
          "ON QUIET STREETS THAT REPLACED THE OLD GREENHOUSES.\n" +
          "IT'S LONG BEEN ONE OF THE CITY'S MORE ATTAINABLE WAYS\n" +
          "INTO A DETACHED HOUSE WITH A YARD.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR THE PORTOLA ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A single-family home with a front garden", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN THE PORTOLA?\n" +
          "SOMEONE WHO WANTS SUN, A REAL YARD, AND A GROUNDED,\n" +
          "WORKING-FAMILY NEIGHBORHOOD WHERE THE WORLD EATS ON ONE MAIN STREET.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY PORTOLA NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING THE PORTOLA HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass up San Bruno Ave (you, relaxed, not pitching)", "A quiet look toward the McLaren Park hills", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the San Bruno Ave strip, the Woolsey St greenhouses, single-family garden blocks, and the McLaren Park edge in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, storefronts, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Portola page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Portola + University Mound + Visitacion Valley in one morning loop.",
  },
"Visitacion Valley": {
    aka: "Viz Valley",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Visitacion%20Valley&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Visitacion Valley)",
    route: {
      // Route stays ENTIRELY within the Visitacion Valley boundary (verified
      // against the neighborhood polygon). Coords approximate — I'll snap to the
      // sidewalk grid for the final cut.
      spots: [
        { n: 1, name: "Leland Avenue main street", note: "Start — the little Leland Ave commercial strip, the heart of the neighborhood", coord: [-122.4072, 37.7126] },
        { n: 2, name: "Visitacion Valley Greenway gardens", note: "The chain of one-block community gardens climbing the hillside", coord: [-122.4090, 37.7142] },
        { n: 3, name: "McLaren Park edge", note: "The green western flank — the park rising right above the homes", coord: [-122.4132, 37.7153] },
        { n: 4, name: "Single-family-home block (Rutland St)", note: "The housing-stock segment: modest single-family homes on the residential slopes", coord: [-122.4045, 37.7148] },
        { n: 5, name: "Schlage Lock redevelopment edge", note: "The former Schlage Lock factory site — now the Baylands North build-out near the Caltrain side", coord: [-122.4043, 37.7117] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON LELAND AVENUE IN VISITACION VALLEY, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE VISITACION VALLEY? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Leland Ave in the next", "You moving up Leland Ave into frame", "The Leland Ave main street to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? VISITACION VALLEY SITS AT SAN FRANCISCO'S\n" +
          "FAR SOUTHEAST EDGE, TUCKED BETWEEN McLAREN PARK AND THE OLD COW PALACE,\n" +
          "JUST ABOVE THE COUNTY LINE WITH DALY CITY AND BRISBANE.\n" +
          "THE MAIN SPINE IS LELAND AVENUE — A SMALL, FRIENDLY MAIN STREET —\n" +
          "WITH THE GREEN SLOPES OF McLAREN PARK RISING ON ONE FLANK.\n" +
          "THE LAND TELLS A STORY OF TWO HALVES.\n" +
          "THE LELAND AVENUE VALLEY FLOOR IS FAIRLY LEVEL AND EASY TO GET AROUND —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "BUT THIS IS SAN FRANCISCO, SO THE RESIDENTIAL STREETS CLIMB\n" +
          "THE SURROUNDING HILLS — RISING FROM ABOUT 20 FEET\n" +
          "DOWN ON THE FLAT UP TO ROUGHLY 380 FEET ON THE UPPER BLOCKS.\n" +
          "ON THOSE CLIMBS THE GRADE QUICKLY PASSES WHAT THE A-D-A\n" +
          "CONSIDERS AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE VALLEY FLOOR IS YOUR FRIEND; THE UPPER BLOCKS ARE A CLIMB.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan up Leland Ave; the main-street storefronts", "Wide establishing shot showing the valley + McLaren Park ridge", "A genuinely steep residential cross-street climbing the hill (show the grade)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. THE VALLEY GOT ITS NAME IN 1777,\n" +
          "WHEN SPANISH FRIARS AND SOLDIERS BOUND FOR THE NEW PRESIDIO\n" +
          "CAMPED IN THIS BAYSIDE VALLEY ON THE CATHOLIC FEAST OF THE VISITATION.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "THROUGH THE 1800s IT WAS A LANDSCAPE OF FARMS AND DAIRIES\n" +
          "ON THE OLD RANCHO CAÑADA DE GUADALUPE LA VISITACION Y RODEO VIEJO.\n" +
          "THEN, IN 1926, THE SCHLAGE LOCK COMPANY OPENED A FACTORY HERE\n" +
          "THAT MADE LOCKS AND ANCHORED THE LOCAL ECONOMY FOR MORE THAN SEVENTY YEARS,\n" +
          "DRAWING A WORKING-CLASS IMMIGRANT COMMUNITY TO THE VALLEY.\n" +
          "SCHLAGE CLOSED IN 1999, AND THAT FORMER PLANT IS NOW BEING REDEVELOPED\n" +
          "AS THE MIXED-USE BAYLANDS NORTH COMMUNITY — APPROVED IN 2014 —\n" +
          "WITH ROUGHLY SIXTEEN HUNDRED AND SEVENTY NEW HOMES.\n" +
          "THROUGH ALL OF IT, THIS HAS STAYED A QUIET WORKING-FAMILY VALLEY\n" +
          "AT THE CITY'S SOUTHERN EDGE.\n" +
          "TODAY IT'S ONE OF SAN FRANCISCO'S MOST DIVERSE NEIGHBORHOODS,\n" +
          "WITH ASIAN RESIDENTS MAKING UP OVER HALF THE POPULATION.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING IN A REAL WORKING HISTORY.",
        broll: ["Modest valley homes and the Leland Ave storefronts", "The former Schlage Lock site / Baylands North construction", "A quiet residential block climbing toward the park"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "RUNNING UP THE HILLSIDE FROM LELAND AVENUE IS THE\n" +
          "VISITACION VALLEY GREENWAY — A CHAIN OF SIX ONE-BLOCK PARKS\n" +
          "AND COMMUNITY GARDENS, BEGUN BY NEIGHBORS IN THE YEAR 2000,\n" +
          "STITCHING THE MAIN STREET TOWARD McLAREN PARK.\n" +
          "AND McLAREN PARK ITSELF — ON THE NEIGHBORHOOD'S FLANK —\n" +
          "IS THE SECOND-LARGEST PARK IN THE WHOLE CITY,\n" +
          "MORE THAN THREE HUNDRED ACRES OF HILLS, TRAILS, AND OPEN GREEN.\n" +
          "THE VALLEY EVEN TAKES ITS NAME FROM A FEAST DAY —\n" +
          "THAT 1777 CAMP ON THE FEAST OF THE VISITATION.\n" +
          "AND DOWN AT THE SOUTH END, SUNNYDALE STATION\n" +
          "ANCHORS THE T-THIRD LIGHT RAIL LINE, WHICH SINCE 2023\n" +
          "RUNS ALL THE WAY THROUGH DOWNTOWN TO CHINATOWN.\n" +
          "THIS IS A NEIGHBORHOOD THAT QUIETLY REWARDS THE PEOPLE WHO LOOK CLOSELY.",
        broll: ["The greenway gardens climbing the hill", "McLaren Park trails and open green", "A T-Third train at Sunnydale Station"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "OUT HERE IN THE FAR SOUTHEAST, VISITACION VALLEY IS GENERALLY SUNNY —\n" +
          "IT SITS AWAY FROM THE THICK SUMMER FOG THAT SWALLOWS THE WEST SIDE.\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND VISITACION VALLEY IS BETTER CONNECTED\n" +
          "THAN ITS QUIET EDGE-OF-THE-CITY FEEL SUGGESTS.\n" +
          "DOWN AT SUNNYDALE STATION IS THE T-THIRD MUNI METRO LINE,\n" +
          "WHICH SINCE 2023 RUNS STRAIGHT THROUGH DOWNTOWN TO CHINATOWN.\n" +
          "THE 8-BAYSHORE, THE 9-SAN BRUNO, AND THE 56 BUSES SERVE THE AREA,\n" +
          "AND CALTRAIN IS RIGHT THERE AT THE BAYSHORE STATION JUST TO THE EAST.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT FIVE-AND-A-HALF MILES NORTH,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? TAKE TRANSIT DOWNTOWN AND HOP BART —\n" +
          "DOWNTOWN OAKLAND IS ABOUT FORTY-FIVE MINUTES ALL IN.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR.\n" +
          "HEADING SOUTH TO THE PENINSULA? CALTRAIN FROM THE BAYSHORE STATION\n" +
          "RUNS DOWN THE PENINSULA IN ABOUT FORTY TO FIFTY MINUTES —\n" +
          "OR IT'S A SIMILAR DRIVE ON 101 OR 280.\n" +
          "THAT BAYSHORE-STATION CALTRAIN STOP IS THE REAL SECRET WEAPON HERE:\n" +
          "FEW SAN FRANCISCO NEIGHBORHOODS PUT THE PENINSULA THIS CLOSE.\n" +
          "BOTTOM LINE: LIGHT RAIL, CALTRAIN, A FERRY, AND THE BRIDGES —\n" +
          "ALL WITHIN REACH WITHOUT OWNING A CAR.",
        broll: [
          "Sunnydale Station / a T-Third train; a bus on Bayshore Blvd",
          "Bayshore Caltrain station; the Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; a Caltrain heading south",
          "Simple motion-graphic map: Visitacion Valley → Oakland / Larkspur / the Peninsula with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS FIRST: THIS IS AN INLAND VALLEY, SET BACK FROM THE OPEN BAY,\n" +
          "SO IT IS NOT IN A TSUNAMI HAZARD ZONE — CROSS THAT WORRY OFF THE LIST.\n" +
          "LIKE MUCH OF HILLY SAN FRANCISCO, PARTS OF THE NEIGHBORHOOD —\n" +
          "ESPECIALLY SOME OF THE LOWER GROUND — DO FALL WITHIN A\n" +
          "STATE-DESIGNATED SEISMIC HAZARD ZONE.\n" +
          "THAT'S STANDARD FOR THIS PART OF THE CITY, AND IT'S SOMETHING\n" +
          "EVERY CALIFORNIA BUYER REVIEWS WITH THEIR INSPECTOR AND INSURER.\n" +
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the valley floor and the hills around it", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "LELAND AVENUE IS A SMALL, GENUINELY LOCAL MAIN STREET —\n" +
          "FAMILY-RUN KITCHENS, A NEIGHBORHOOD BAR OR TWO,\n" +
          "AND THE KIND OF MULTICULTURAL, EVERYDAY MIX YOU ONLY FIND\n" +
          "IN A REAL WORKING NEIGHBORHOOD RATHER THAN A TOURIST STRIP.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY VISITACION VALLEY DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A QUIET, KNOW-YOUR-NEIGHBORS, EVERYDAY KIND OF PLACE.",
        broll: ["Leland Ave storefronts; a family-run restaurant window", "People on the main-street sidewalk", "A neighborhood bar sign (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: VISITACION VALLEY IS ONE OF THE CITY'S MORE\n" +
          "DOWN-TO-EARTH RESIDENTIAL POCKETS —\n" +
          "MODEST SINGLE-FAMILY HOMES ON THE HILLSIDE BLOCKS,\n" +
          "OLDER VALLEY COTTAGES NEAR LELAND AVENUE,\n" +
          "AND BRAND-NEW CONDOS AND TOWNHOMES RISING AT THE BAYLANDS NORTH BUILD-OUT.\n" +
          "IT RUNS FROM A FIRST STARTER HOME TO SOMETHING NEWLY BUILT.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR VISITACION VALLEY ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A modest single-family home, a valley cottage, a new townhome at Baylands North", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN VISITACION VALLEY?\n" +
          "SOMEONE WHO WANTS SUN, A REAL COMMUNITY, AND EASY REACH\n" +
          "TO BOTH DOWNTOWN AND THE PENINSULA — WITHOUT THE DOWNTOWN PRICE TAG.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY VISITACION VALLEY NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING VISITACION VALLEY HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass down Leland Ave (you, relaxed, not pitching)", "A quiet look up the hill toward McLaren Park", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the Leland Ave main street, the greenway gardens, McLaren Park, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the station entrance, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Visitacion Valley page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Visitacion Valley + Sunnydale + Little Hollywood in one morning loop.",
  },
"Sunnyside": {
    aka: null,
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Sunnyside&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Sunnyside)",
    route: {
      // Route stays ENTIRELY within the Sunnyside boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Monterey Blvd shops", note: "Start — the low-key commercial spine; the level heart of the neighborhood", coord: [-122.4456, 37.7320] },
        { n: 2, name: "Sunnyside Conservatory", note: "Octagonal redwood Victorian conservatory (c.1901), ringed by mature palms", coord: [-122.4450, 37.7322] },
        { n: 3, name: "Family-home block — Detroit & Hearst", note: "Rows of early-1900s cottages on quiet residential streets", coord: [-122.4470, 37.7300] },
        { n: 4, name: "Glen Canyon Park edge", note: "The wild canyon greenbelt on the neighborhood's northeast shoulder", coord: [-122.4394, 37.7331] },
        { n: 5, name: "Mount Davidson approach", note: "Where the streets begin to climb toward the city's high point", coord: [-122.4511, 37.7332] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON MONTEREY BOULEVARD IN SUNNYSIDE, AND THE SUN IS OUT —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE SUNNYSIDE? LET'S GO.",
        broll: ["Two-shot idea: a foggy ridge in one frame, sunny Monterey Blvd in the next", "You moving along Monterey Blvd into frame", "A row of cottages climbing toward Mount Davidson to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? SUNNYSIDE SITS IN SOUTH-CENTRAL SAN FRANCISCO,\n" +
          "TUCKED BELOW MOUNT DAVIDSON, THE CITY'S HIGHEST HILL,\n" +
          "WITH GLEN CANYON AND GLEN PARK JUST TO THE NORTHEAST.\n" +
          "THE MAIN SPINE IS MONTEREY BOULEVARD, RUNNING EAST-WEST\n" +
          "THROUGH A LOW-KEY ROW OF NEIGHBORHOOD SHOPS.\n" +
          "AND TRUE TO THE NAME, THIS IS ONE OF THE SUNNIER POCKETS DOWN HERE —\n" +
          "SHELTERED IN THE LEE OF MOUNT DAVIDSON, THOUGH IT CAN STILL CATCH SOME FOG.\n" +
          "MONTEREY BOULEVARD ITSELF IS FAIRLY LEVEL AND EASY TO GET AROUND —\n" +
          "FRIENDLY WHETHER YOU'RE PUSHING A STROLLER OR ROLLING A WHEELCHAIR.\n" +
          "BUT THIS IS SAN FRANCISCO, SO THE STREETS CLIMB FAST:\n" +
          "THE NEIGHBORHOOD RISES FROM ABOUT 170 FEET NEAR THE BOULEVARD\n" +
          "TO ROUGHLY 500 FEET AS YOU HEAD UP TOWARD MOUNT DAVIDSON,\n" +
          "AND THOSE UPPER GRADES QUICKLY PASS WHAT THE A-D-A CONSIDERS\n" +
          "AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "THE BOULEVARD AND THE FLATTER BLOCKS ARE YOUR FRIEND; THE UPPER STREETS ARE A CLIMB.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "MANY OF THESE CLASSIC COTTAGES SIT UP A FLIGHT OF STAIRS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan along Monterey Blvd; street signs at the commercial strip", "Wide establishing shot showing the slope up to Mount Davidson", "A genuinely steep cross-street climbing toward the summit (show the grade)"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. SUNNYSIDE WAS LAID OUT IN THE 1890s\n" +
          "AS ONE OF THE CITY'S EARLY STREETCAR SUBURBS.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "THE SUBDIVISION WAS THE WORK OF BEHREND JOOST,\n" +
          "WHO HAD A BIGGER AMBITION THAN SELLING LOTS — HE WANTED TRANSIT.\n" +
          "IN 1892 HE BUILT THE CITY'S FIRST ELECTRIC STREETCAR LINE,\n" +
          "POWERED FROM A POWERHOUSE RIGHT HERE ON WHAT IS NOW MONTEREY BOULEVARD,\n" +
          "AND THAT STREETCAR DREW THE FIRST BUYERS OUT TO THE NEW TRACT.\n" +
          "THROUGH THE EARLY 1900s THE STREETS FILLED IN\n" +
          "WITH MODEST COTTAGES AND SINGLE-FAMILY HOMES,\n" +
          "TUCKED DOWN BELOW MOUNT DAVIDSON AND NEXT TO GLEN CANYON.\n" +
          "IT GREW UP AS A FRIENDLY, FAMILY KIND OF PLACE — AND IT STILL IS.\n" +
          "THE NAME ITSELF WAS A SELLING POINT:\n" +
          "AN OPEN, SUNNY, SOUTH-FACING SLOPE, MARKETED FOR ITS LIGHT.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING IN ONE OF\n" +
          "THE CITY'S FIRST COMMUTER NEIGHBORHOODS — BUILT AROUND A STREETCAR\n" +
          "THAT CHANGED HOW SAN FRANCISCO GREW.",
        broll: ["Early-1900s cottage facades along the quiet streets", "Monterey Blvd where the old powerhouse once stood", "The Sunnyside Conservatory amid its palms"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "BEHREND JOOST DIDN'T JUST SUBDIVIDE THIS TRACT — HE BUILT\n" +
          "THE FIRST ELECTRIC STREETCAR LINE IN ALL OF SAN FRANCISCO TO SERVE IT.\n" +
          "MONTEREY BOULEVARD, THE STREET I'M STANDING ON, WASN'T ALWAYS CALLED THAT —\n" +
          "IT STARTED LIFE AS 'SUNNYSIDE AVENUE,' THE TRACT'S MAIN ROAD.\n" +
          "AND TUCKED IN A FEW BLOCKS AWAY IS A REAL SURPRISE:\n" +
          "THE SUNNYSIDE CONSERVATORY, AN OCTAGONAL REDWOOD VICTORIAN GLASSHOUSE\n" +
          "BUILT AROUND 1901, NOW A CITY LANDMARK RINGED BY MATURE PALMS.\n" +
          "JUST OVER THE NORTHEAST SHOULDER IS GLEN CANYON,\n" +
          "A GENUINELY WILD GREENBELT OF ROCK AND CREEK IN THE MIDDLE OF THE CITY.\n" +
          "THIS IS A NEIGHBORHOOD THAT KEEPS ITS HISTORY QUIETLY,\n" +
          "BUT IT'S RIGHT THERE ONCE YOU KNOW WHERE TO LOOK.",
        broll: ["Sunnyside Conservatory exterior + palms", "A Monterey Blvd street sign", "Glen Canyon's rocky greenbelt and creek"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "SUNNYSIDE EARNS ITS NAME — IT'S ONE OF THE SUNNIER POCKETS DOWN HERE,\n" +
          "SITTING IN THE LEE OF MOUNT DAVIDSON, WHICH SHELTERS IT FROM THE WORST\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND SUNNYSIDE IS GENUINELY EASY TO LIVE IN\n" +
          "WITHOUT LEANING ON A CAR.\n" +
          "JUST EAST OF THE NEIGHBORHOOD IS GLEN PARK BART,\n" +
          "WHICH PUTS THE WHOLE REGIONAL RAIL SYSTEM A SHORT HOP AWAY.\n" +
          "MUNI BUSES SERVE THE NEIGHBORHOOD DIRECTLY —\n" +
          "THE 36, THE 43, THE 44, AND THE 23 THREAD THROUGH THESE HILLS —\n" +
          "AND THE J, K, AND M MUNI METRO LINES RUN A BIT AWAY ON OCEAN AVENUE.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT FIVE AND A HALF MILES NORTHEAST,\n" +
          "AND THAT'S YOUR GATEWAY TO THE WATER.\n" +
          "GOING TO THE EAST BAY? FROM GLEN PARK, TAKE BART —\n" +
          "DOWNTOWN OAKLAND IS A STRAIGHT RIDE UNDER THE BAY.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE BART OR MUNI TOWARD THE CALTRAIN DEPOT,\n" +
          "AND CALTRAIN RUNS DOWN TO PALO ALTO IN ABOUT FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101.\n" +
          "BOTTOM LINE: WATER, RAIL, AND THREE BRIDGES — ALL WITHIN EASY REACH,\n" +
          "AND BART RIGHT NEXT DOOR AT GLEN PARK.",
        broll: [
          "Glen Park BART entrance; a 36 or 43 bus on a Sunnyside street",
          "Embarcadero / the Ferry Building / a departing ferry",
          "A BART train; the Golden Gate Bridge; a Caltrain at 4th & King",
          "Simple motion-graphic map: Sunnyside → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS FIRST: SUNNYSIDE SITS WELL INLAND AND ELEVATED, BELOW MOUNT DAVIDSON,\n" +
          "SO IT IS NOT IN A TSUNAMI HAZARD ZONE — CROSS THAT WORRY OFF THE LIST.\n" +
          "LIKE MUCH OF HILLY SAN FRANCISCO, PARTS OF THE NEIGHBORHOOD\n" +
          "DO FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THAT'S STANDARD FOR THE CITY'S SLOPES, AND IT'S SOMETHING\n" +
      ...
      },
      {
        ...
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "SUNNYSIDE'S MONTEREY BOULEVARD STRIP IS LOW-KEY AND NEIGHBORHOOD-SCALED —\n" +
          "COFFEE, A FEW SOLID FAMILY RESTAURANTS, AND A COUPLE OF FRIENDLY LOCAL SPOTS.\n" +
          "IT'S NOT A NIGHTLIFE DESTINATION, AND THAT'S RATHER THE POINT —\n" +
          "THIS IS A QUIET, LIVED-IN KIND OF PLACE.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND SPOTS RIGHT ON MY SUNNYSIDE DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: GLEN PARK'S SHOPS ARE CLOSE, AND DOWNTOWN IS A QUICK BART RIDE.",
        broll: ["Café tables on Monterey Blvd; a busy restaurant window", "The low-key commercial strip in the daytime", "A friendly local storefront (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: SUNNYSIDE IS CLASSIC SOUTH-CENTRAL SAN FRANCISCO —\n" +
          "ROWS OF EARLY-1900s COTTAGES AND MODEST SINGLE-FAMILY HOMES\n" +
          "ON QUIET STREETS, WITH SOME LARGER HOMES UP THE SLOPE TOWARD MOUNT DAVIDSON.\n" +
          "IT'S LONG BEEN ONE OF THE CITY'S MORE ATTAINABLE SINGLE-FAMILY POCKETS.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR SUNNYSIDE ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES AND FOR CONDOS, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["An early-1900s cottage, a single-family home, a larger uphill house", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN SUNNYSIDE?\n" +
          "SOMEONE WHO WANTS LIGHT, QUIET, AND A REAL FAMILY NEIGHBORHOOD,\n" +
          "WITH BART NEXT DOOR AND THE WHOLE BAY AREA WITHIN EASY REACH.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY SUNNYSIDE NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING SUNNYSIDE HOME, I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass along Monterey Blvd (you, relaxed, not pitching)", "A quiet look up the slope toward Mount Davidson", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot the Monterey Blvd strip, the conservatory, the cottage streets, and the slope up to Mount Davidson in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the Glen Park BART entrance, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Sunnyside page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Sunnyside + Glen Park + Westwood Park in one morning loop.",
  },
"Oceanview": {
    aka: "Part of OMI",
    runtime: "~10 min (8–10 target)",
    marketLink: "https://www.ur4cast.com/listings?nbhd=Oceanview&layer=nbhd",
    detailsLink: "https://www.ur4cast.com/fog (open the Neighborhoods card → Oceanview)",
    route: {
      // Route stays ENTIRELY within the Oceanview boundary (verified against the
      // neighborhood polygon). Coords approximate — I'll snap to the sidewalk
      // grid for the final cut.
      spots: [
        { n: 1, name: "Broad & Randolph", note: "Start — the historic village core of Ocean View, where the old Broad Street businesses clustered", coord: [-122.4585, 37.7165] },
        { n: 2, name: "Randolph Street corridor", note: "The neighborhood's commercial spine; small shops and the everyday heart of the OMI", coord: [-122.4560, 37.7160] },
        { n: 3, name: "Brooks Park", note: "A hilltop community park with native gardens and big southwest views", coord: [-122.4598, 37.7172] },
        { n: 4, name: "Capitol Avenue — single-family blocks", note: "The housing-stock segment: modest single-family homes on rolling residential streets", coord: [-122.4570, 37.7150] },
        { n: 5, name: "Ocean Avenue edge", note: "The north edge where the K-Ingleside runs down Ocean Ave toward Balboa Park", coord: [-122.4544, 37.7178] },
      ],
    },
    sections: [
      {
        ...
        script:
          ...
          "AREN'T FOUND IN A LISTING — THEY'RE IN THE DETAILS YOU ONLY KNOW\n" +
          "ONCE YOU'VE STOOD ON THE CORNER AT DIFFERENT TIMES OF DAY.\n" +
          "RIGHT NOW I'M ON RANDOLPH STREET IN OCEANVIEW, AND THE FOG IS ROLLING IN —\n" +
          "WHICH IS ALREADY THE FIRST THING WORTH KNOWING ABOUT THIS PLACE.\n" +
          "SO — ARE YOU READY TO SEE OCEANVIEW? LET'S GO.",
        broll: ["Two-shot idea: a foggy southwest ridge in one frame, a sunny break in the next", "You moving up Randolph St into frame", "The Broad St / Randolph St corner to place us"],
      },
      {
        label: "1 · LOCATION & LAY OF THE LAND",
        words: 195,
        script:
          "FIRST — WHERE ARE WE? OCEANVIEW SITS IN SAN FRANCISCO'S FAR SOUTHWEST,\n" +
          "RIGHT UP AGAINST THE SOUTHERN EDGE OF THE CITY AND DALY CITY.\n" +
          "IT'S THE 'O' IN THE OMI — OCEANVIEW, MERCED HEIGHTS, AND INGLESIDE —\n" +
          "THREE NEIGHBORHOODS THAT HAVE LONG SHARED ONE COMMUNITY.\n" +
          "THE EVERYDAY HEART RUNS ALONG THE BROAD STREET AND RANDOLPH STREET BLOCKS,\n" +
          "WITH THE OCEAN AVENUE CORRIDOR ALONG THE NORTH EDGE.\n" +
          "THE LAND HERE ROLLS — ROUGHLY 220 TO 520 FEET UP,\n" +
          "WITH MODERATE GRADES ON THE RESIDENTIAL STREETS.\n" +
          "SOME BLOCKS ARE GENTLE AND EASY TO GET AROUND, WHETHER YOU'RE\n" +
          "PUSHING A STROLLER OR ROLLING A WHEELCHAIR —\n" +
          "BUT OTHERS CLIMB, AND THE GRADE ON THE STEEPER ONES\n" +
          "CAN PASS WHAT THE A-D-A CONSIDERS AN ACCESSIBLE SLOPE — ABOUT FIVE PERCENT.\n" +
          "SO IF STEP-FREE, LOW-GRADE ACCESS MATTERS TO YOU,\n" +
          "IT'S WORTH CHECKING THE SPECIFIC BLOCK.\n" +
          "AND THE HOMES THEMSELVES MATTER TOO —\n" +
          "THESE ARE MOSTLY MODEST SINGLE-FAMILY HOMES,\n" +
          "AND MANY SIT UP A FEW STEPS FROM THE SIDEWALK,\n" +
          "SO IF STEP-FREE ENTRY IS A MUST, IT'S WORTH CHECKING HOME BY HOME.",
        broll: ["Slow pan up Randolph St; street signs at Broad & Randolph", "Wide establishing shot showing the rolling streets toward Daly City", "A residential cross-street showing a moderate grade"],
      },
      {
        label: "2 · HISTORY",
        words: 200,
        script:
          "NOW THE STORY. OCEANVIEW IS PART OF THE HISTORICALLY DIVERSE OMI DISTRICT,\n" +
          "AND IT'S ONE OF THE OLDEST CORNERS OF THE SOUTHWEST CITY.\n" +
          "ALL OF THIS WAS THE ANCESTRAL LAND OF THE RAMAYTUSH OHLONE LONG BEFORE THAT.\n" +
          "OCEAN VIEW GREW UP AROUND A RAILROAD STOP IN THE 1860s,\n" +
          "AND BY 1883 IT WAS SUBDIVIDED INTO A SELF-CONTAINED VILLAGE —\n" +
          "WITH ITS OWN SCHOOL, POST OFFICE, AND CHURCHES ALONG BROAD STREET.\n" +
          "THEN CAME THE TURN. AFTER WORLD WAR TWO,\n" +
          "OCEAN VIEW BECAME ONE OF THE FEW PLACES IN SAN FRANCISCO\n" +
          "WHERE AFRICAN-AMERICAN FAMILIES COULD BUY HOMES,\n" +
          "AND DURING WESTERN ADDITION REDEVELOPMENT IN THE 1960s AND 70s,\n" +
          "MANY MORE FAMILIES MOVED IN.\n" +
          "RESIDENTS COINED THE NAME 'OMI' IN THE 1960s TO LOBBY TOGETHER\n" +
          "FOR CITY SERVICES, AND THE AREA BECAME ONE OF THE CITY'S\n" +
          "EARLIEST RACIALLY INTEGRATED COMMUNITIES.\n" +
          "TODAY IT'S STILL A WORKING-FAMILY NEIGHBORHOOD OF MODEST SINGLE-FAMILY HOMES.\n" +
          "SPEND TIME ON THESE BLOCKS, AND YOU'RE STANDING IN A REAL PIECE OF\n" +
          "SAN FRANCISCO'S CIVIL-RIGHTS HISTORY.",
        broll: ["Modest single-family facades along the residential blocks", "Broad Street — the old village core", "A church on Broad St dating to the 1890s"],
      },
      {
        label: "3 · HIDDEN FACTS",
        words: 160,
        script:
          "HERE'S WHAT MOST PEOPLE DON'T KNOW.\n" +
          "OCEAN VIEW FUNCTIONED AS ITS OWN VILLAGE LONG BEFORE THE CITY GREW OUT TO MEET IT —\n" +
          "ST. MICHAEL'S CHURCH WENT UP ON BROAD STREET IN 1899,\n" +
          "AND THERE'S BEEN A CONGREGATIONAL CHURCH THERE SINCE 1895.\n" +
          "JUST WEST, IN INGLESIDE TERRACES, URBANO DRIVE STILL TRACES AN OVAL —\n" +
          "THE LOOP OF THE 1895 INGLESIDE RACETRACK, PAVED OVER WHEN HOMES WENT IN IN 1912.\n" +
          "CITY COLLEGE OF SAN FRANCISCO OPENED IN 1935, AND ITS 56-ACRE OCEAN CAMPUS\n" +
          "SITS JUST NORTH OF THE NEIGHBORHOOD.\n" +
          "AND THE STREETCARS ARE NAMED FOR THIS AREA:\n" +
          "THE M OCEAN VIEW LINE, BUILT IN 1927, AND THE K INGLESIDE BOTH STILL RUN,\n" +
          "TERMINATING DOWN AT BALBOA PARK STATION.\n" +
          "THIS IS A NEIGHBORHOOD THAT QUIETLY HOLDS A LOT OF HISTORY.",
        broll: ["Broad Street churches", "Urbano Drive's oval over in Ingleside Terraces", "An M Ocean View or K Ingleside streetcar"],
      },
      {
        label: "4 · MICROCLIMATE",
        words: 95,
        script:
          "QUICK WORD ON WEATHER — BECAUSE IN SAN FRANCISCO, MICROCLIMATE IS EVERYTHING.\n" +
          "OCEANVIEW SITS IN THE SOUTHWEST PART OF THE CITY,\n" +
          "WHICH CATCHES THE MARINE LAYER ROLLING IN OFF THE PACIFIC.\n" +
      ...
      },
      {
        ...
        script:
          "NOW THE PART THAT REALLY MATTERS IF YOU'RE BUYING HERE:\n" +
          "HOW YOU GET AROUND. AND OCEANVIEW IS BETTER CONNECTED THAN YOU'D EXPECT\n" +
          "FOR A CORNER THIS FAR OUT.\n" +
          "THE K-INGLESIDE MUNI METRO RUNS RIGHT DOWN OCEAN AVENUE,\n" +
          "AND THE M-OCEAN VIEW LINE RUNS NEARBY — BOTH HEADING THROUGH TO DOWNTOWN.\n" +
          "BUSES INCLUDE THE 29, THE 54, THE 8, AND THE 49,\n" +
          "THREADING ACROSS THE SOUTH OF THE CITY.\n" +
          "NEAREST BART IS BALBOA PARK STATION, JUST TO THE EAST.\n" +
          "NOW LET'S LEAVE THE CITY — CAR-FREE.\n" +
          "THE FERRY BUILDING IS ABOUT SIX AND A HALF MILES NORTHEAST,\n" +
          "AND YOUR GATEWAY TO THE WATER IS THE MUNI METRO STRAIGHT DOWNTOWN TO EMBARCADERO.\n" +
          "GOING TO THE EAST BAY? FROM BALBOA PARK STATION, HOP BART —\n" +
          "IT RUNS YOU UNDER THE BAY TOWARD OAKLAND WITHOUT A TRANSFER DOWNTOWN.\n" +
          "HEADING NORTH TO MARIN? THE LARKSPUR FERRY LEAVES FROM THE FERRY BUILDING\n" +
          "AND CROSSES IN ABOUT THIRTY MINUTES ON THE WATER —\n" +
          "OR DRIVE THE GOLDEN GATE BRIDGE TO LARKSPUR IN ABOUT THIRTY.\n" +
          "HEADING SOUTH TO THE PENINSULA? TAKE MUNI OR BART TOWARD THE CALTRAIN DEPOT,\n" +
          "AND CALTRAIN RUNS DOWN TO PALO ALTO IN ABOUT FIFTY MINUTES —\n" +
          "OR IT'S ROUGHLY THE SAME BY CAR ON 280 OR 101, WHICH ARE BOTH CLOSE.\n" +
          "BOTTOM LINE: METRO, BART, WATER, AND THE FREEWAYS — ALL WITHIN EASY REACH,\n" +
          "EVEN WITHOUT OWNING A CAR.",
        broll: [
          "The K-Ingleside running down Ocean Ave; a bus on Randolph",
          "Balboa Park Station + a BART train",
          "The Ferry Building / a departing ferry; the Golden Gate Bridge; a Caltrain",
          "Simple motion-graphic map: Oceanview → Oakland / Larkspur / Palo Alto with the times",
        ],
      },
      {
        label: "6 · THE GROUND UNDER YOU (HAZARDS)",
        ...
        script:
          "TWO QUICK, HONEST NOTES ON THE GROUND ITSELF.\n" +
          "GOOD NEWS FIRST: OCEANVIEW SITS INLAND AND ELEVATED, WELL ABOVE THE BAY,\n" +
          "SO IT IS NOT IN A TSUNAMI HAZARD ZONE — CROSS THAT WORRY OFF THE LIST.\n" +
          "LIKE MUCH OF HILLY SAN FRANCISCO, PARTS OF THE NEIGHBORHOOD\n" +
          "DO FALL WITHIN A STATE-DESIGNATED SEISMIC HAZARD ZONE —\n" +
          "THAT'S STANDARD FOR THE CITY'S SLOPES, AND IT'S SOMETHING\n" +
          ...
          "I PUT THE SEISMIC AND TSUNAMI STATUS RIGHT ON EACH NEIGHBORHOOD'S\n" +
          "DETAILS PAGE, SO YOU CAN CHECK ANY SPECIFIC BLOCK BEFORE YOU WRITE AN OFFER.",
        broll: ["You gesturing to the rolling hillside streets", "Edit: the seismic + tsunami toggles on your fog map"],
      },
      {
        label: "7 · DINING, NIGHTLIFE & DAILY LIFE",
        words: 120,
        script:
          "LET'S TALK DAILY LIFE.\n" +
          "OCEANVIEW IS A QUIET, RESIDENTIAL PLACE AT HEART,\n" +
          "BUT THE OCEAN AVENUE AND RANDOLPH STREET CORRIDORS\n" +
          "GIVE YOU EVERYDAY SHOPS, A FEW NEIGHBORHOOD RESTAURANTS, AND A LOCAL BAR OR TWO.\n" +
          "I'M NOT GOING TO NAME SPECIFIC PLACES ON CAMERA, BECAUSE THE LINEUP CHANGES —\n" +
          "AND I NEVER WANT TO SEND YOU SOMEWHERE THAT'S CLOSED.\n" +
          "INSTEAD, I KEEP A CURRENT, HAND-CHECKED LIST OF THE NEIGHBORHOOD'S BEST\n" +
          "RESTAURANTS AND BARS RIGHT ON MY OCEANVIEW DETAILS PAGE — ALWAYS UP TO DATE.\n" +
          "THE VIBE TO KNOW: THIS IS A SETTLED, WORKING-FAMILY, KNOW-YOUR-NEIGHBORS KIND OF PLACE.",
        broll: ["Shops along Ocean Ave; a neighborhood café window", "Quiet residential street life", "A local corner business (general, not a single endorsement)"],
      },
      {
        label: "8 · REAL ESTATE",
        words: 120,
        script:
          "ON HOUSING: OCEANVIEW IS A WORKING-FAMILY NEIGHBORHOOD —\n" +
          "MOSTLY MODEST SINGLE-FAMILY HOMES ON ROLLING RESIDENTIAL STREETS,\n" +
          "MANY OF THEM UP A FEW STEPS FROM THE SIDEWALK.\n" +
          "IT'S LONG BEEN ONE OF THE CITY'S MORE ATTAINABLE CORNERS,\n" +
          "WHICH IS A BIG PART OF WHY FAMILIES PUT DOWN ROOTS HERE.\n" +
          "I'M NOT GOING TO QUOTE A MEDIAN PRICE ON CAMERA, BECAUSE THAT NUMBER MOVES.\n" +
          "INSTEAD, I KEEP A LIVE MARKET UPDATE FOR OCEANVIEW ON MY SITE —\n" +
          "CURRENT MEDIANS FOR SINGLE-FAMILY HOMES, RIGHT UP TO TODAY.\n" +
          "THE LINK IS BELOW. THAT'S YOUR SMARTEST FIRST STEP BEFORE YOU EVEN TOUR.",
        broll: ["A row of modest single-family homes", "A 'For Sale' sign", "Edit: lower-third + screen-record of your live market page"],
      },
      {
        label: "9 · WHO BELONGS HERE + SIGNATURE OUTRO",
        words: 120,
        script:
          "SO — WHO BELONGS IN OCEANVIEW?\n" +
          "SOMEONE WHO WANTS A REAL, SETTLED NEIGHBORHOOD AND ATTAINABLE SINGLE-FAMILY HOMES,\n" +
          "WITH METRO AND BART CARRYING THE WHOLE BAY AREA WITHIN REACH.\n" +
          "BUT HERE'S THE THING I'VE LEARNED AFTER ALL THESE YEARS:\n" +
          "EVERY NEIGHBORHOOD IN THIS CITY HAS A STORY LIKE THIS ONE,\n" +
          "AND KNOWING THEM ALL IS THE WORK — THE MICROCLIMATES,\n" +
          "THE STREETS THAT HOLD THEIR VALUE, THE THINGS THAT NEVER SHOW UP IN A SEARCH.\n" +
          "ANYTHING THAT CHANGES — PRICES, THE NEWEST RESTAURANT, WHAT'S FOR SALE —\n" +
          "STAYS CURRENT ON MY OCEANVIEW NEIGHBORHOOD PAGE, SO THIS GUIDE NEVER GOES STALE.\n" +
          "SO IF YOU'RE THINKING ABOUT CALLING OCEANVIEW HOME,\n" +
          "I'D LOVE TO SHOW YOU AROUND AND HELP CREATE YOUR NEXT LIFE ADVENTURE.",
        broll: ["Golden-hour, unhurried pass down Randolph St (you, relaxed, not pitching)", "A quiet look out over the rolling southwest blocks", "Soft end card: your name + how to reach you"],
      },
    ],
    schedule: [
      { step: "Scout & lock script", detail: "Take the route, mark the 6–8 B-roll stops, finalize edits to this script.", time: "~45 min (day before)" },
      { step: "Golden-hour B-roll", detail: "Shoot Broad & Randolph, Brooks Park, the single-family blocks, street life, and housing variety in good light.", time: "30–45 min (early AM or ~1 hr before sunset)" },
      { step: "Talk-to-camera takes", detail: "Shoot each section as its own clip at the relevant spot; 2 takes each; teleprompter on your phone.", time: "60–90 min" },
      { step: "Pickups & cutaways", detail: "Signs, the Ocean Ave Metro, and a screen-record of your live market page (capture at home).", time: "~15 min" },
      { step: "Edit & caption", detail: "Assemble, add lower-thirds (market URL), burned-in captions, light music bed; export.", time: "2–3 hrs" },
      { step: "Publish & link", detail: "Upload to YouTube, paste the market link in the description — then I add the 'Watch the tour' button to the Oceanview page.", time: "~30 min" },
    ],
    batchTip: "Shoot adjacent hoods the same outing — e.g. Oceanview + Ingleside + Merced Heights in one OMI loop.",
  },
};
