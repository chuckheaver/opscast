...
// Shows the metric icon/label/description, current ideal range, an exclude
// toggle, a band visualization, and two sliders (min and max).
...
export default function MetricCard({ metric, threshCfg, setThresh }) {
  ...
  return (
    <div className={`mc ${excluded ? "excluded" : ""}`}>
      <div className="mc-bar">
        <div
          className="mc-strip"
          style={{ background: excluded ? "#ddd" : "#C8EAC8" }}
        />
          ...
          <div className="mc-head">
            <div className="mc-title-row">
              ...
              <div>
                ...
                {excluded && (
                  <div className="mc-range">Excluded from forecast</div>
                )}
              </div>
            </div>
            <div className="excl-toggle" onClick={toggle}>
              <div className={`excl-box ${excluded ? "on" : ""}`}>
                {excluded && (
