...
//   • Sun         — < 8.6 hrs/day  → flat bright yellow
//   • Transition  — 8.6–9          → partly-cloudy texture overlay
...
// transition zone (8.6–9) is rendered as a separate pattern layer
// on top of this base gradient.
export const riskColorStops = [
  [0,    "#fde047"], // Sun       — bright yellow
  [8.6,  "#fde047"], // Sun       — flat to here
...
export const TRANSITION_RANGE = [8.6, 9];
