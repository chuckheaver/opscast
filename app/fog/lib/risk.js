...
//   • Sun         — < 8.2 hrs/day  → flat bright yellow
//   • Transition  — 8.2–8.7        → partly-cloudy texture overlay
//                                    (see FogMap.jsx, "partly-cloudy" pattern)
//   • Fog         — > 8.7          → light grey → near-black gradient
//
...
// transition zone (8.2–8.7) is rendered as a separate pattern layer
// on top of this base gradient.
export const riskColorStops = [
  [0,    "#fde047"], // Sun       — bright yellow
  [8.2,  "#fde047"], // Sun       — flat to here
  [8.7,  "#d6d3d1"], // Fog start — light grey
