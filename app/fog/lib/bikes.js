...
export const BIKE_CLASSES = [
  ...
  { key: "CLASS III", label: "Class III · shared / sharrows", short: "Cl3Sha", color: "#6b7280", dashed: true },
  { key: "CLASS IV", label: "Class IV · separated", short: "Cl4Sep", color: "#22c55e", dashed: false },
];
